...
public:
    ...
    /// proton: starts
    size_t allocatedMetadataBytes() const override { return 0; }
    bool equal(size_t, size_t, const IColumn &, int) const override { return true; }
    bool equal(size_t, const Field &, int) const override { return true; }
    /// proton: ends

...
TEST(ColumnDynamic, CreateEmpty)
{
    ...
    ASSERT_EQ(column->getVariantInfo().variant_type->getName(), "variant(shared_variant)");
    ASSERT_EQ(column->getVariantInfo().variant_names.size(), 1);
    ASSERT_EQ(column->getVariantInfo().variant_names[0], "shared_variant");
    ASSERT_EQ(column->getVariantInfo().variant_name_to_discriminator.size(), 1);
    ASSERT_EQ(column->getVariantInfo().variant_name_to_discriminator.at("shared_variant"), 0);
...
TEST(ColumnDynamic, InsertFields)
{
    ...
    ASSERT_EQ(column->getVariantInfo().variant_type->getName(), "variant(float64, int8, shared_variant, string)");
    std::vector<String> expected_names = {"float64", "int8", "shared_variant", "string"};
    ASSERT_EQ(column->getVariantInfo().variant_names, expected_names);
    std::unordered_map<String, UInt8> expected_variant_name_to_discriminator = {{"float64", 0}, {"int8", 1}, {"shared_variant", 2}, {"string", 3}};
...
TEST(ColumnDynamic, InsertFrom1)
{
    ...
    checkInsertFrom(getInsertFromColumn(), column_to, "variant(float64, int8, shared_variant, string)", {"float64", "int8", "shared_variant", "string"}, {{"float64", 0}, {"int8", 1}, {"shared_variant", 2}, {"string", 3}});
}
...
TEST(ColumnDynamic, InsertFrom3)
{
    ...
    checkInsertFrom(getInsertFromColumn(), column_to, "variant(array(int8), float64, int8, shared_variant, string)", {"array(int8)", "float64", "int8", "shared_variant", "string"}, {{"array(int8)", 0}, {"float64", 1}, {"int8", 2}, {"shared_variant", 3}, {"string", 4}});
}
...
{
    auto column_to = ColumnDynamic::create(254);
    checkInsertManyFrom(getInsertFromColumn(), column_to, "variant(float64, int8, shared_variant, string)", {"float64", "int8", "shared_variant", "string"}, {{"float64", 0}, {"int8", 1}, {"shared_variant", 2}, {"string", 3}});
}
...
TEST(ColumnDynamic, InsertManyFrom3)
{
    ...
    checkInsertManyFrom(getInsertFromColumn(), column_to, "variant(array(int8), float64, int8, shared_variant, string)", {"array(int8)", "float64", "int8", "shared_variant", "string"}, {{"array(int8)", 0}, {"float64", 1}, {"int8", 2}, {"shared_variant", 3}, {"string", 4}});
}
...
{
    auto column_to = ColumnDynamic::create(254);
    checkInsertRangeFrom(getInsertFromColumn(2), column_to, "variant(float64, int8, shared_variant, string)", {"float64", "int8", "shared_variant", "string"}, {{"float64", 0}, {"int8", 1}, {"shared_variant", 2}, {"string", 3}});
}
...
TEST(ColumnDynamic, InsertRangeFrom3)
{
    ...
    checkInsertRangeFrom(getInsertFromColumn(2), column_to, "variant(array(int8), float64, int8, shared_variant, string)", {"array(int8)", "float64", "int8", "shared_variant", "string"}, {{"array(int8)", 0}, {"float64", 1}, {"int8", 2}, {"shared_variant", 3}, {"string", 4}});
}
...
TEST(ColumnDynamic, SerializeDeserializeFromArena2)
{
    ...
    ASSERT_EQ(column_to->getVariantInfo().variant_type->getName(), "variant(float64, int8, shared_variant, string)");
    std::vector<String> expected_names = {"float64", "int8", "shared_variant", "string"};
    ASSERT_EQ(column_to->getVariantInfo().variant_names, expected_names);
    std::unordered_map<String, UInt8> expected_variant_name_to_discriminator = {{"float64", 0}, {"int8", 1}, {"shared_variant", 2}, {"string", 3}};
    ASSERT_TRUE(column_to->getVariantInfo().variant_name_to_discriminator == expected_variant_name_to_discriminator);
...
TEST(ColumnDynamic, skipSerializedInArena)
{
    ...
    ASSERT_EQ(pos, end);
    ASSERT_EQ(column_to->getVariantInfo().variant_name_to_discriminator.at("shared_variant"), 0);
    ASSERT_EQ(column_to->getVariantInfo().variant_names, Names{"shared_variant"});
}

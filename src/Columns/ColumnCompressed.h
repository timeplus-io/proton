...
public:
    ...
    /// proton: starts
    bool equal(size_t, size_t, const IColumn &, int) const override { throwMustBeDecompressed(); }
    bool equal(size_t, const Field &, int) const override { throwMustBeDecompressed(); }
    /// proton: ends

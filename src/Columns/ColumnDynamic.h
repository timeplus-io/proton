...
public:
    ...
    {
        variant_column_ptr->updateWeakHash32(hash);
    }
    ...
    { 
        throw Exception(ErrorCodes::NOT_IMPLEMENTED, "equal is not implemented for variant");
    }
    ...
    {
        return variant_column->allocatedMetadataBytes();
    }
    /// proton: ends

...
void ColumnFixedString::insert(const Field & x)
{
    ...
    if (s.size() > n)
        throw Exception(ErrorCodes::TOO_LARGE_STRING_SIZE, "Too large string '{}' for fixed_string column", s);
...
#endif
{
    ...
    if (n != src.getN())
        throw Exception(ErrorCodes::SIZE_OF_FIXED_STRING_DOESNT_MATCH, "Size of fixed_string doesn't match");

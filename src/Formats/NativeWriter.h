...
public:
    ...
    /// proton: starts
    /// If enabled, write more block info contents including watermark/sequence number etc.
    /// Mainly used for transmission between internal clusters.
    void enableInternalChannel() { internal_channel_enabled = true; }
    /// proton: ends
...
private:
    ...
    /// proton: starts
    bool internal_channel_enabled{false};
    /// proton: ends

...
FormatSettings getFormatSettings(ContextPtr context, const Settings & settings)
{
    ...
    format_settings.pretty.single_large_number_tip_threshold = settings.output_format_pretty_single_large_number_tip_threshold;
    ...
    format_settings.ignore_parsing_errors = settings.input_format_ignore_parsing_errors;
    /// proton: ends
    ...
    format_settings.schema_inference_make_json_columns_nullable = settings.schema_inference_make_json_columns_nullable;
    ...
    format_settings.precise_float_parsing = settings.precise_float_parsing;
    ...
    format_settings.binary.write_json_as_string = settings.output_format_binary_write_json_as_string;
    format_settings.binary.read_json_as_string = settings.input_format_binary_read_json_as_string;
    ...
    format_settings.native.write_json_as_string = settings.output_format_native_write_json_as_string;
    ...
    format_settings.open_search.index_column = settings.output_format_opensearch_index_column;
    format_settings.open_search.include_index_column_in_document = settings.output_format_opensearch_include_index_column_in_document;
    format_settings.open_search.id_column = settings.output_format_opensearch_id_column;
    format_settings.open_search.include_id_column_in_document = settings.output_format_opensearch_include_id_column_in_document;
    /// proton: ends
...
String FormatFactory::getContentType(
    ...
    const std::optional<FormatSettings> & _format_settings) const
{
    return getContentType(name, /*header=*/{}, context, _format_settings);
}

/// Not all formats can work when using an empty block as header.
String FormatFactory::getContentType(
    const String & name,
    const Block & header,
    ContextPtr context,
    const std::optional<FormatSettings> & _format_settings) const
{
    ...
    auto format = output_getter(empty_buffer, header, format_settings);

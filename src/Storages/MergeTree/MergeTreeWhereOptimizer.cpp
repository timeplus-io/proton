...
void MergeTreeWhereOptimizer::optimize(SelectQueryInfo & select_query_info, const ContextPtr & context) const
{
    ...
    /// proton: starts. FIXME. Porting https://github.com/ClickHouse/ClickHouse/pull/43227 Improve masking sensitive info

...
void MutatePlainMergeTreeTask::prepare()
{
    ...
    /// Emit a MUTATE_PART_START at the very start so duration is measurable end-to-end
    /// from system.part_log alone (a paired MUTATE_PART row will land at finalization).

    ...
    , sample_block(sample_block_)
{
    ...
    ASTPtr partition_by_string = makeASTFunction("to_string", std::move(arguments));
...
void PartitionedSink::consume(Chunk chunk)
{
    ...
    {
        auto partition_key = partition_by_result_column->isNullAt(row) ? "null" : partition_by_result_column->getDataAt(row);

...
struct MutationCommand
{
    ...
    /// proton: starts
    String toAlterCommandString(
        const String & table_name,
        const String & database_name,
        ASTAlterQuery::AlterObjectType type = ASTAlterQuery::AlterObjectType::STREAM) const;
    /// proton: ends
};
...
public:
    ...
    /// proton: starts
    std::vector<std::string> stringCommands() const;
    static std::optional<MutationCommands> fromAlterCommandString(std::string_view query_string);
    /// proton: ends

...
void registerStorageMaterializedPostgreSQL(StorageFactory & factory)
{
    auto creator_fn = [](const StorageFactory::Arguments & args)
    {
        ...
        if (!args.getLocalContext()->getSettingsRef().allow_experimental_materialized_postgresql_table)
        ...
        return std::make_shared<StorageMaterializedPostgreSQL>(
                args.table_id, configuration.database, configuration.table, connection_info,

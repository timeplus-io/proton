...
private:
    ...
    static void onMessageDelivery(rd_pulsar_t * /* producer */, const rd_pulsar_message_t * msg, void *  /*opaque*/);
    void onMessageDelivery(const rd_pulsar_message_t * msg);
    ...
    rd_pulsar_resp_err_t lastSeenError() const { return static_cast<rd_pulsar_resp_err_t>(state.last_error_code.load()); }

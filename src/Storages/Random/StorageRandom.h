...
#define STORAGE_RANDOM_RELATED_SETTINGS(M, ALIAS) \
...
#define LIST_OF_STORAGE_RANDOM_SETTINGS(M, ALIAS) \
    STORAGE_RANDOM_RELATED_SETTINGS(M, ALIAS) \
...
private:
    ...
    std::atomic<Int64> metric_time;
    std::atomic<UInt64> read_bytes;
    std::atomic<UInt64> read_rows;

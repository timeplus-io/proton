...
void MySQLSettings::loadFromQueryContext(ContextPtr context, ASTStorage & storage_def)
{
    ...
    if (settings.mysql_datatypes_support_level.value != impl->mysql_datatypes_support_level.value)
    {
        static constexpr auto setting_name = "mysql_datatypes_support_level";
        impl->mysql_datatypes_support_level = settings.mysql_datatypes_support_level;

...
///
/// Also this class write and flush special x-timeplus-progress HTTP headers
...
private:
    ...
    /// Used to write the header x-timeplus-progress / Xx-timeplus-summary
    void writeHeaderProgressImpl(const char * header_name);
    /// Used to write the header x-timeplus-progress
    void writeHeaderProgress();
    /// Used to write the header x-timeplus-summary
    void writeHeaderSummary();
    /// Use to write the header x-timeplus-exception-code even when progress has been sent

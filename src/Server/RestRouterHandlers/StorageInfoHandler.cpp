...
StorageInfoPtr StorageInfoHandler::loadStorageInfo(const String & ns, const String & stream) const
{
...
void StorageInfoHandler::loadLocalStoragesInfo(StorageInfoPtr & disk_info, const String & ns, const String & stream) const
{
    const auto access = query_context->getAccess();
    if (stream.empty())
    {

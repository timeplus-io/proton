...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    /* proton: starts */ \
    M(SHOW_FORMAT_SCHEMAS, "", GLOBAL, SHOW) /* allows to execute SHOW FORMAT SCHEMAS, SHOW CREATE FORMAT SCHEMA */\
    M(SHOW_FUNCTIONS, "", GLOBAL, SHOW) /* allows to execute SHOW FUNCTIONS, SHOW CREATE FUNCTION <functionName> */ \
    M(SHOW_ALERTS, "", GLOBAL, SHOW) /* allows to execute SHOW ALERTS, SHOW CREATE ALERT */\
    M(SHOW_TASKS, "", GLOBAL, SHOW) /* allows to execute SHOW TASKS, SHOW CREATE TASKS */\
    M(SHOW_DISKS, "", GLOBAL, SHOW) /* allows to execute SHOW DISKS, SHOW CREATE DISK */ \
    /* proton: ends */ \
    ...
    M(CREATE_DISK, "", GLOBAL, CREATE) /* allows to execute CREATE DISK */ \
    M(CREATE_STORAGE_POLICY, "", GLOBAL, CREATE) /* allows to execute CREATE STORAGE POLICY */ \
    M(CREATE_ALERT, "", GLOBAL, CREATE) /* allows to execute CREATE ALERT */ \
    M(CREATE_TASK, "", GLOBAL, CREATE) /* allows to execute CREATE TASK */ \
    /* proton: ends */ \
    ...
    M(DROP_DISK, "", GLOBAL, DROP) /* allows to execute DROP DISK */ \
    M(DROP_STORAGE_POLICY, "", GLOBAL, DROP) /* allows to execute DROP STORAGE POLICY */ \
    M(DROP_ALERT, "", GLOBAL, DROP) /* allows to execute DROP ALERT */ \
    M(DROP_TASK, "", GLOBAL, DROP) /* allows to execute DROP TASK */ \
    /* proton: ends */ \
    ...
    /* proton: starts */ \
    M(SYSTEM_TASK, "SYSTEM PAUSE TASK, SYSTEM RESUME TASK", GLOBAL, SYSTEM) \
    /* proton: ends */ \

...
AccessRightsElement::AccessRightsElement(AccessFlags access_flags_, std::string_view database_, const std::string_view & table_)
...
AccessRightsElement::AccessRightsElement(
    AccessFlags access_flags_, std::string_view database_, const std::string_view & table_, const std::string_view & column_)
...
AccessRightsElement::AccessRightsElement(
    AccessFlags access_flags_, std::string_view database_, const std::string_view & table_, const Strings & columns_)
    : access_flags(access_flags_)
    , database(database_)
    , table(table_)
    , columns(columns_)

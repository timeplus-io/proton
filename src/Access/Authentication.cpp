...
namespace
{
    ...
    bool checkPasswordSHA256(std::string_view password, const Digest & password_sha256)
    {
        return Util::encodeSHA256(password) == password_sha256;
    }

    bool checkPasswordDoubleSHA1MySQL(std::string_view scramble, const std::string_view & scrambled_password, const Digest & password_double_sha1)
    {
    ...
    bool checkPasswordPlainTextMySQL(std::string_view scramble, const std::string_view & scrambled_password, const Digest & password_plaintext)
    {

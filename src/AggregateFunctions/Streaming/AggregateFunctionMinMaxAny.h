...
public:
    ...
    bool insert(const IColumn & column, size_t row_num, Arena * arena, UInt32 count)
    {
        return values.insert(assert_cast<const ColVecType &>(column).getData()[row_num], count);
    }
...
public:
    ...
    bool insert(const IColumn & column, size_t row_num, Arena * arena, UInt32 count)
    {
        return values.insert(assert_cast<const ColVecType &>(column).getDataAt(row_num).toString(), count);
    }
...
public:
    ...
    bool insert(const IColumn & column, size_t row_num, Arena * arena, UInt32 count)
    {
        return values.insert(column[row_num], count);
    }

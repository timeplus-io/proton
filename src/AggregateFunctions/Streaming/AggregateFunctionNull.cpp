...
#include <AggregateFunctions/Streaming/AggregateFunctionNull.h>
...
{
public:
    String getName() const override { return "_null_retract"; }
        ...
        const Array & params) const override
    {
        ...
        if (!has_nullable_types)
            throw Exception(
                ...
                "Aggregate function combinator '_null_retract' requires at least one argument to be nullable");
        ...
        if (arguments.size() == 1)
            throw Exception(ErrorCodes::LOGICAL_ERROR, "Aggregate function combinator '_null_retract' requires at least two arguments");
...
void registerAggregateFunctionCombinatorNullRetract(AggregateFunctionCombinatorFactory & factory)
{

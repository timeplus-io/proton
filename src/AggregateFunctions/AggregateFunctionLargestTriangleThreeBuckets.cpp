...
{
    factory.registerFunction(AggregateFunctionLargestTriangleThreeBucketsName, createAggregateFunctionLargestTriangleThreeBuckets);
    factory.registerAlias("lttb", AggregateFunctionLargestTriangleThreeBucketsName);
}

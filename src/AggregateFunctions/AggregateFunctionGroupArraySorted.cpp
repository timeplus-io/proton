...
public:
    ...
    String getName() const override { return "group_array_sorted"; }
...
{
    assertUnary(name, argument_types);//. move in?
...
void registerAggregateFunctionGroupArraySorted(AggregateFunctionFactory & factory)
{
    ...
    factory.registerFunction("group_array_sorted", { createAggregateFunctionGroupArray, properties });
}

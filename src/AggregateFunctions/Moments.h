...
struct VarMoments
{
    ...
    T get() const
    {
        throw Exception(ErrorCodes::LOGICAL_ERROR, "Variation moments should be obtained by either 'get_sample' or 'get_population' method");
    }
...
struct CovarMoments
{
    ...
    T get() const
    {
        throw Exception(ErrorCodes::LOGICAL_ERROR, "Covariation moments should be obtained by either 'get_sample' or 'get_population' method");
    }
...
struct CorrMoments
{
    ...
    T getMoment3() const
    {
        throw Exception(ErrorCodes::LOGICAL_ERROR, "Correlation moments should be obtained by either 'get_sample' or 'get_population' method");
    }

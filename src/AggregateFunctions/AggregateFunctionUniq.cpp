...
void registerAggregateFunctionsUniq(AggregateFunctionFactory & factory)
{
    ...
    factory.registerFunction("unique_hll12",
    ...
    factory.registerFunction("unique_exact", {assign_bool_param, properties});

#if USE_DATASKETCHES
    factory.registerFunction("unique_theta",
        {createAggregateFunctionUniq<AggregateFunctionUniqThetaData, AggregateFunctionUniqThetaDataForVariadic>, properties});

    factory.registerAlias("uniq_theta", "unique_theta");
#endif

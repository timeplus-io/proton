...
/// proton : starts
void TableJoin::addAlignmentKeys(const ASTPtr & left_table_ast, const ASTPtr & right_table_ast)
{
    left_alignment_key_column = left_table_ast->getColumnName();
    right_alignment_key_column = right_table_ast->getAliasOrColumnName();
}

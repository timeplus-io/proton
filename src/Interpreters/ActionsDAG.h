...
/// proton: starts. FIXME. Porting https://github.com/ClickHouse/ClickHouse/pull/31796 new analyser first
/// class FunctionNode;
/// proton: ends.
...
public:
    ...
    struct Node
    {
        ...
        /// proton: starts.
        std::function<ExecutableFunctionPtr()> function_builder;
        /// proton: ends.
...
public:
    ...
    /// proton: starts. add deep clone stateful functions, which is used for substream processing etc.
    ActionsDAGPtr clone(bool deep_clone = false) const;
    /// proton: ends.

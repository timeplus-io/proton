...
InterpreterCreateQuery::TableProperties InterpreterCreateQuery::getTablePropertiesAndNormalizeCreateQuery(ASTCreateQuery & create) const
{
    ...
    {
        Block as_select_sample = InterpreterSelectWithUnionQuery::getSampleBlock(create.select->clone(), getContext(), false, nullptr);
...
static void generateUUIDForTable(ASTCreateQuery & create)
{
    ...
    bool need_uuid_for_inner_table = !create.attach && create.is_materialized_view && create.to_table_id.empty();
    /// proton: ends.

...
TEST(StreamingRowRefs, FindAsof)
{
    ...
    std::vector<Case> cases = {
        {.row_num = 0,
         .keep_versions = 6,
         .inequality = DB::ASOF::Inequality::Greater,
         .expected_block_count = 3,
         .expected_block_idx = {},
         .expected_matching_row = {}},
        {.row_num = 0,
         .keep_versions = 6,
         .inequality = DB::ASOF::Inequality::GreaterOrEquals,
         .expected_block_count = 3,
         .expected_block_idx = {0},
         .expected_matching_row = {0}},
        {.row_num = 0,
         .keep_versions = 6,
         .inequality = DB::ASOF::Inequality::Less,
         .expected_block_count = 3,
         .expected_block_idx = {0},
         .expected_matching_row = {1}},
        {.row_num = 0,
         .keep_versions = 6,
         .inequality = DB::ASOF::Inequality::LessOrEquals,
         .expected_block_count = 3,
         .expected_block_idx = {0},
         .expected_matching_row = {0}},

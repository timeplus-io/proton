...
public:
    ...
    std::shared_ptr<InternalHashJoin> getInternalHashJoin(size_t transform_id) { return hash_joins.at(transform_id); }
    ...
    /// used for concurrent HybridHashJoin
    void write(VersionType);

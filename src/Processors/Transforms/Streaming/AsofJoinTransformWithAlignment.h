...
/// left stream -> ... ->
///                      \
///                      AsofJoinTransformWithAlignment
///                      /
/// right stream -> ... ->
class AsofJoinTransformWithAlignment final : public JoinTransformWithAlignment
{
public:
    using JoinTransformWithAlignment::JoinTransformWithAlignment;
    String getName() const override { return "StreamingAsofJoinTransformWithAlignment"; }
};
}

...
/// left stream -> ... ->
///                      \
///                      LatestJoinTransformWithAlignment
///                      /
/// right stream -> ... ->
class LatestJoinTransformWithAlignment final : public JoinTransformWithAlignment
{
public:
    using JoinTransformWithAlignment::JoinTransformWithAlignment;
    String getName() const override { return "StreamingLatestJoinTransformWithAlignment"; }
};
}

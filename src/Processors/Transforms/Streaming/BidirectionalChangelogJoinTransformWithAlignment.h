...
///                      /
/// right stream -> ... ->
class BidirectionalChangelogJoinTransformWithAlignment final : public JoinTransformWithAlignment
{
public:
    using JoinTransformWithAlignment::JoinTransformWithAlignment;
    String getName() const override { return "StreamingBidirectionalChangelogJoinTransformWithAlignment"; }
};
}

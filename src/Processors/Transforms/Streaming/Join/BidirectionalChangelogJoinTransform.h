...
/// left stream -> ... ->
///                      \
///                      BidirectionalChangelogJoinTransform
///                      /
/// right stream -> ... ->
class BidirectionalChangelogJoinTransform final : public JoinTransform
{
public:
    using JoinTransform::JoinTransform;
    String getName() const override { return "StreamingBidirectionalChangelogJoinTransform"; }
};
}
}

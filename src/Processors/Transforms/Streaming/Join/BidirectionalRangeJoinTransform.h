...
/// left stream -> ... ->
///                      \
///                      BidirectionalRangeJoinTransform
///                      /
/// right stream -> ... ->
class BidirectionalRangeJoinTransform final : public JoinTransform
{
public:
    using JoinTransform::JoinTransform;
    String getName() const override { return "StreamingBidirectionalRangeJoinTransform"; }
};
}
}

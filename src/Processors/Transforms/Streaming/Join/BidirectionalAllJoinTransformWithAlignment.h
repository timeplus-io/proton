...
///                      /
/// right stream -> ... ->
class BidirectionalAllJoinTransformWithAlignment final : public JoinTransformWithAlignment
{
public:
    using JoinTransformWithAlignment::JoinTransformWithAlignment;
    String getName() const override { return "StreamingBidirectionalAllJoinTransformWithAlignment"; }
};
}

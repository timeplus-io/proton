...
public:
    BufferingToFileTransform(const Block & header, TemporaryFileStream & tmp_stream_, LoggerPtr log_)
        : IAccumulatingTransform(header, header, ProcessorID::BufferingToFileTransformID)
...
MergeSortingTransform::MergeSortingTransform(
    ...
    : SortingTransform(header, description_, max_merged_block_size_, limit_, increase_sort_description_compile_attempts, ProcessorID::MergeSortingTransformID)

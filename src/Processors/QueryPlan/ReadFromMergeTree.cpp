...
void ReadFromMergeTree::initializePipeline(QueryPipelineBuilder & pipeline, const BuildQueryPipelineSettings &)
{
    ...
    if (select.final() || (Streaming::isKeyedStorage(data.dataStreamSemantic()) && settings.compact_kv_stream.value)) /// proton : for changelog_kv or versioned_kv, we always enforce final
    {

...
VersionsFilterStep::VersionsFilterStep(
...
void VersionsFilterStep::transformPipeline(QueryPipelineBuilder & pipeline, const BuildQueryPipelineSettings & /* settings */)
{
...
void VersionsFilterStep::updateOutputStream()
{
...
String VersionsFilterStep::getName() const
{
    switch (hash_table_type)
    {
        case HashTableType::Memory:
            return "VersionsFilterStep";
        case HashTableType::Hybrid:
            return "HybridVersionsFilterStep";
    }
}
}
}

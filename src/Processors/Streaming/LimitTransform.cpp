#include <Processors/Streaming/LimitTransform.h>
...
LimitTransform::LimitTransform(
    ...
    : IProcessor(InputPorts(num_streams, header_), OutputPorts(num_streams, header_), ProcessorID::StreamingLimitTransformID)
    , limit(limit_)
    , offset(offset_)

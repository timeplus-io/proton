...
void RowInputFormatWithNamesAndTypes::resetParser()
{
    ...
    /// proton: starts
    /// Do not reset column_mapping, because the mapping coule be set
    /// via the setColumnMapping function. In such case, if the column_mapping is reset, the information will be lost.

...
JSONColumnsBlockOutputFormat::JSONColumnsBlockOutputFormat(WriteBuffer & out_, const Block & header_, const FormatSettings & format_settings_, size_t indent_, ProcessorID pid_)
    : JSONColumnsBlockOutputFormatBase(out_, header_, format_settings_, pid_), fields(header_.getNamesAndTypes()), indent(indent_)
{

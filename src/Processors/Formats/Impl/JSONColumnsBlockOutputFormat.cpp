...
JSONColumnsBlockOutputFormat::JSONColumnsBlockOutputFormat(WriteBuffer & out_, const Block & header_, const FormatSettings & format_settings_, bool validate_utf8, size_t indent_, ProcessorID pid_)
    : JSONColumnsBlockOutputFormatBase(out_, header_, format_settings_, validate_utf8, pid_), indent(indent_)
{

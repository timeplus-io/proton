...
CSVRowInputFormat::CSVRowInputFormat(
    ...
    : RowInputFormatWithNamesAndTypes(
        ...
        *in_,
        ...
        ProcessorID::CSVRowInputFormatID),
    buf(std::move(in_))
{
    ...
    const String & /*column_name*/)
{
    ...
    if (format_settings.null_as_default && !isNullableOrLowCardinalityNullable(type))
    {
        ...
        return SerializationNullable::deserializeNullAsDefaultOrNestedTextCSV(column, *in, format_settings, serialization);
    }
...
void registerFileSegmentationEngineCSV(FormatFactory & factory)
{
    auto register_func = [&](const String & format_name, bool, bool)
    {
        ...
        factory.registerFileSegmentationEngine(format_name, [](ReadBuffer & in, DB::Memory<> & memory, size_t min_chunk_size)
        {

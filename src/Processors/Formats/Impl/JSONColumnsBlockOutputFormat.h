...
{
public:
    JSONColumnsBlockOutputFormat(WriteBuffer & out_, const Block & header_, const FormatSettings & format_settings_, bool validate_utf8, size_t indent_ = 0, ProcessorID pid_ = ProcessorID::JSONColumnsBlockOutputFormatID);

...
JSONRowOutputFormat::JSONRowOutputFormat(
    ...
    bool yield_strings_,
    ProcessorID pid_)
    : RowOutputFormatWithExceptionHandlerAdaptor<RowOutputFormatWithUTF8ValidationAdaptor, bool>(header, out_, settings_.json.valid_output_on_exception, true, pid_), settings(settings_), yield_strings(yield_strings_)
{

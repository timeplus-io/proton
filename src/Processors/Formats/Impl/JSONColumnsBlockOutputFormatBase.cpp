...
JSONColumnsBlockOutputFormatBase::JSONColumnsBlockOutputFormatBase(
    WriteBuffer & out_, const Block & header_, const FormatSettings & format_settings_, bool validate_utf8, ProcessorID pid_)
    : OutputFormatWithUTF8ValidationAdaptor(header_, out_, validate_utf8, pid_)

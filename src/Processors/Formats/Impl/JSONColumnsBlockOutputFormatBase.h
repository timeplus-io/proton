...
{
public:
    JSONColumnsBlockOutputFormatBase(WriteBuffer & out_, const Block & header_, const FormatSettings & format_settings_, bool validate_utf8, ProcessorID pid_ = ProcessorID::JSONColumnsBlockOutputFormatBaseID);

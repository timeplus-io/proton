...
CapnProtoRowOutputFormat::CapnProtoRowOutputFormat(
    ...
    : IRowOutputFormat(header_, out_, ProcessorID::CapnProtoRowOutputFormatID), column_names(header_.getNames()), column_types(header_.getDataTypes()), output_stream(std::make_unique<CapnProtoOutputStream>(out_)), format_settings(format_settings_)
{

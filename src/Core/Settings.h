...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, enable_extended_results_for_datetime_functions, true, "Enable date functions like toLastDayOfMonth return Date32 results (instead of Date results) for Date32/DateTime64 arguments.", 0) \
    \

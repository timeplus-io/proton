...
#define APPLY_FOR_ERROR_CODES(M) \
    ...
    M(57, STREAM_ALREADY_EXISTS) \
    M(58, STREAM_METADATA_ALREADY_EXISTS) \
    ...
    M(189, STREAM_MUST_NOT_BE_CREATED_MANUALLY) \
    ...
    M(359, STREAM_SIZE_EXCEEDS_MAX_DROP_SIZE_LIMIT) \
    ...
    M(370, DATA_TYPE_CANNOT_BE_USED_IN_STREAMS) \
    ...
    M(390, CANNOT_GET_CREATE_STREAM_QUERY) \
    ...
    M(442, BAD_DATABASE_FOR_TEMPORARY_STREAM) \
    ...
    M(520, CANNOT_DETACH_DICTIONARY_AS_STREAM) \
    ...
    M(582, NO_SUCH_PROJECTION_IN_STREAM) \
    ...
    M(634, MONGODB_ERROR) \
    M(635, CANNOT_POLL) \
    M(636, CANNOT_EXTRACT_STREAM_STRUCTURE) \
    M(637, INVALID_STREAM_OVERRIDE) \
    ...
    M(737, ICEBERG_CONFLICT_ERROR) \
    M(700, PYTHON_EXECUTE_ERROR) \
    M(701, PYTHON_IMPORT_ERROR) \
    M(702, PYTHON_PIP_ERROR) \
    ...
    M(800, INVALID_DISK) \
    M(990, MATERIALIZED_VIEW_STATUS_CHANGED) \
    M(991, MATERIALIZED_VIEW_STOPPED) \
    M(993, CHECKPOINT_ALREADY_EXISTS) \
    M(994, CHECKPOINT_DOESNT_EXIST) \
    M(995, CREATE_CHECKPOINT_FAILED) \
    M(996, CANNOT_PARSE_VALUE) \
    M(997, UNSUPPORTED) \
    ...
    M(2002, WINDOW_COLUMN_NOT_REFERENCED) \
    M(2004, RESOURCE_NOT_INITED) \
    M(2005, RESOURCE_ALREADY_EXISTS) \
    M(2006, DWAL_FATAL_ERROR) \
    M(2007, CONFIG_ERROR) \
    M(2008, UNRETRIABLE_ERROR) \
    M(2013, DWAL_RETRIABLE_ERROR) \
    M(2014, INVALID_OPERATION) \
    M(2015, MSG_SIZE_TOO_LARGE) \
    M(2016, INTERNAL_INGEST_BUFFER_FULL) \
    M(2017, INVALID_REPLICATION_FACTOR) \
    M(2018, INVALID_LOGSTORE_REPLICATION_FACTOR) \
    M(2019, MISSING_ACKNOWLEDGEMENT) \
    M(2500, SEQUENCE_OUT_OF_RANGE) \
    M(2501, CANNOT_LOCK_FILE) \
    M(2502, BAD_VERSION) \
    M(2503, FILE_CORRUPTION) \
    M(2504, INVALID_DATA) \
    M(2505, LOG_DIR_UNAVAILABLE) \
    M(2506, LOG_ALREADY_EXISTS) \
    M(2507, BAD_FILE_NAME) \
    M(2508, CANNOT_READ_FILE) \
    M(2509, INVALID_STATE) \
    M(2510, INVALID_SEQUENCE) \
    M(2511, CANNOT_FLUSH_FILE) \
    M(2512, LOG_NOT_EXISTS) \
    M(2513, INVALID_RECORD) \
    M(2514, TOO_LARGE_RECORD) \
    M(2515, DATA_CORRUPTION) \
    M(2516, TOO_LARGE_RECORD_BATCH) \
    M(2517, APPEND_ONLY) \
    M(2518, CANNOT_OPEN_DATABASE) \
    M(2519, INSERT_KEY_VALUE_FAILED) \
    M(2520, DELETE_KEY_VALUE_FAILED) \
    M(2521, INVALID_STREAMING_FUNC_DESC) \
    M(2522, MISSING_GROUP_BY) \
    M(2523, INVALID_EMIT_MODE) \
    M(2524, MISSING_SESSION_KEY) \
    M(2525, INTERNAL_ERROR) \
    M(2526, REMOTE_CALL_FAILED) \
    M(2527, UNKNOWN_STREAMING_TABLE_VARIANT) \
    M(2528, RECOVER_CHECKPOINT_FAILED) \
    M(2529, DISK_USAGE_RATIO_THRESHOLD_EXCEEDED) \
    ...
    M(2535, NOT_ENOUGH_NODES) \
    M(2536, CLUSTER_MISMATCH) \
    M(2537, LEADER_WENT_AWAY) \
    M(2538, UNKNOWN_NODE) \
    M(2539, INVALID_REQUEST) \
    M(2540, STALE_FOLLOWER) \
    M(2541, UNKNOWN_SCHEMA_VERSION) \
    M(2542, CLUSTER_ALREADY_INITED) \
    M(2543, SEQUENCE_UNAVAILABLE) \
    M(2544, SNAPSHOT_OUT_OF_DATE) \
    M(2545, PROPOSAL_DROPPED) \
    M(2546, SNAPSHOT_TEMPORARILY_UNAVAILABLE) \
    M(2547, SEQUENCE_COMPACTED_AWAY) \
    M(2548, EMPTY_LOG_ENTRIES) \
    M(2549, INTERNAL_BREAK) \
    M(2550, STEP_LOCAl_MESSAGE) \
    M(2551, STEP_PEER_NOT_FOUND) \
    M(2552, SERVER_INIT_FAILED) \
    M(2553, CLIENT_INIT_FAILED) \
    M(2554, SERVER_BUSY) \
    M(2555, UNREACHABLE) \
    M(2556, NODE_ID_ALREADY_ASSIGNED) \
    M(2557, REPLICA_REMOVED) \
    M(2558, UNEXPECTED_REQUEST) \
    M(2559, TCP_CONNECTION_IS_NOT_READY) \
    M(2560, REQUEST_VERSION_ERROR) \
    M(2561, CLUSTER_NOT_INITED) \
    M(2600, CANNOT_WRITE_TO_KAFKA) \
    M(2601, NO_AVAILABLE_KAFKA_CONSUMER) \
    M(2603, KAFKA_CONSUMER_STOPPED) \
    M(2604, KAFKA_PRODUCER_STOPPED) \
    M(2605, CANNOT_REFRESH_KAFKA_OAUTHBEARER_TOKEN) \
    M(2609, CANNOT_DROP_FORMAT_SCHEMA_CACHE) \
    ...
    M(2614, CANNOT_CREATE_FORMAT_SCHEMA) \
    M(2615, CANNOT_DELETE_FORMAT_SCHEMA) \
    M(2616, SOCKET_SEND_BUFFER_FULL) \
    M(2617, CANNOT_DELETE_FILE) \
    M(2618, FAILED_TO_ROLL_LOG_SEGMENT) \
    M(2619, STREAM_PAUSED) \
    M(2620, RECORD_NOT_FOUND) \
    M(2621, PIPELINE_FINISHED_EARLY) \
    M(2623, INCOMPATIBLE_SCHEMA) \
    M(2624, UDF_RUNNING_ERROR) \
    M(2625, UDF_RETURN_TYPE_ERROR) \
    M(2626, REPLICA_IS_NOT_IN_SYNC) \
    M(2627, METADATA_VERSION_CHANGED) \
    M(2628, MULTIPLE_COLUMNS_SERIALIZED_TO_SAME_AVRO_FIELD) \
    M(2629, CANNOT_CONNECT_SERVER) \
    M(2630, CANNOT_RECEIVE_MESSAGE) \
    M(2631, NODE_NOT_EXISTS) \
    M(2632, NODE_NOT_ALIVE) \
    M(2634, HAS_OPEN_COMMIT) \
    M(2635, TIMER_IS_SATURATED) \
    M(2636, DUPLICATE_REPLICA_ID) \
    M(2637, INVALID_NODE_ID) \
    M(2638, INVALID_REPLICA_ID) \
    M(2639, INVALID_STREAM_ID) \
    M(2640, REPLICA_NOT_EXISTS) \
    M(2641, REPLICA_ALREADY_EXISTS) \
    M(2642, REPLICA_TYPE_MISMATCH) \
    M(2643, PREV_REPLICA_CHANGE_IS_NOT_STARTED) \
    M(2644, QUORUM_PEER_PAUSED) \
    M(2645, ALREADY_HAS_IN_PROGRESS_SNAPSHOT) \
    M(2646, TOO_MANY_SNAPSHOTS) \
    M(2647, SNAPSHOT_SENDER_IS_STALE) \
    M(2648, REPLICA_IS_SHUTDOWN) \
    M(2649, QUEUE_IS_FULL) \
    M(2650, TOO_LARGE_REQUEST) \
    M(2651, DUPLICATE_KEY) \
    M(2653, SNAPSHOT_BATCH_DISCONTINUED_RANGE) \
    M(2654, INGEST_TIMEOUT) \
    M(2655, STREAM_IS_BUSY) \
    M(2656, AWS_ERROR) \
    M(2657, CANNOT_CREATE_DISK) \
    M(2658, DISK_ALREADY_EXISTS) \
    M(2659, CANNOT_DELETE_DISK) \
    M(2660, CANNOT_CREATE_STORAGE_POLICY) \
    M(2661, STORAGE_POLICY_ALREADY_EXISTS) \
    M(2662, CANNOT_DELETE_STORAGE_POLICY) \
    M(2663, FAILED_TO_TAKE_SNAPSHOT) \
    M(2664, UNKNOWN_TABLE) \
    M(2665, META_NODES_UNAVAILABLE) \
    M(2666, CANNOT_SERVE_REQUEST) \
    M(2667, CANNOT_PARSE_DATA) \
    M(2668, SYSTEM_COMMAND_FAILED) \
    M(2669, OPENSEARCH_ERROR) \
    M(2670, TOO_MANY_TRACKING_KEYS) \
    M(2671, CANNOT_CREATE_ALERT) \
    M(2672, CANNOT_DROP_ALERT) \
    M(2673, CANNOT_CREATE_TASK) \
    M(2674, CANNOT_DROP_TASK) \
    M(2675, NOT_ENOUGH_SITES) \
    M(2676, DATA_FETCH_STOPPED) \
    M(2677, UNKNOWN_TASK) \
    M(2678, TASK_IS_DISABLED) \
    M(2686, CANNOT_GET_THREAD_PRIORITY) \
    /* See END */

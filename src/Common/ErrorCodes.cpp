...
#define APPLY_FOR_ERROR_CODES(M) \
    ...
    M(1003, RESOURCE_NOT_FOUND) \
    M(1004, RESOURCE_NOT_INITED) \
    M(1005, RESOURCE_ALREADY_EXISTS) \
    M(1006, DWAL_FATAL_ERROR) \
    M(1007, CONFIG_ERROR) \
    M(1008, UNRETRIABLE_ERROR) \
    M(1010, INVALID_POLL_ID)     \
    M(1011, CHANNEL_ID_NOT_EXISTS) \
    M(1012, SEND_POLL_REQ_ERROR) \
    M(1013, DWAL_RETRIABLE_ERROR) \
    M(1014, INVALID_OPERATION) \
    M(1015, MSG_SIZE_TOO_LARGE) \
    M(1016, INTERNAL_INGEST_BUFFER_FULL) \
    M(1017, INVALID_REPLICATION_FACTOR) \
/* See END */

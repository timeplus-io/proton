...
template <DictionaryKeyType dictionary_key_type, bool sharded>
ColumnUInt8::Ptr HashedArrayDictionary<dictionary_key_type, sharded>::hasKeys(
...
void registerDictionaryArrayHashed(DictionaryFactory & factory)
{
                             ...
                             DictionaryKeyType dictionary_key_type) -> DictionaryPtr
    {
        ...
        configuration.use_async_executor = timeplus_source && timeplus_source->isLocal() && settings.dictionary_use_async_executor;
        /// proton: ends

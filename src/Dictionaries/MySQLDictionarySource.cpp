    ...
    auto create_table_source = [=]([[maybe_unused]] const DictionaryStructure & dict_struct,
        ...
        if (named_collection)
        {
            ...
            if (!mysql_settings[MySQLSetting::connect_timeout].changed)
                mysql_settings[MySQLSetting::connect_timeout] = settings.external_storage_connect_timeout_sec;
            if (!mysql_settings[MySQLSetting::read_write_timeout].changed)
                mysql_settings[MySQLSetting::read_write_timeout] = settings.external_storage_rw_timeout_sec;

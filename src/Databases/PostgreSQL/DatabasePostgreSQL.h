...
public:
    ...
    void loadStoredObjects(ContextMutablePtr, bool force_restore, bool force_attach, bool skip_startup_tables) override;
    ...
    void dropTable(ContextPtr, const String & table_name, bool sync, const ASTPtr & query) override;

    ...
    ProxyConfiguration proxy_configuration)
{
    SSLConfiguration ssl_configuration{
        ...
        .ssl_key_file = private_key_file,
        .ssl_ca_cert_file = ca_location,
        .verification_mode = verification_mode,
    };
    auto connection_pool = HTTPConnectionPools::instance().getPool(group, uri, proxy_configuration, std::move(ssl_configuration));
    return connection_pool->getConnection(timeouts);
}
/// proton: ends

...
template <typename T>
requires is_arithmetic_v<T> || (std::is_standard_layout_v<T> && std::is_trivial_v<T>)
...
/// Skip to next character after next whitespace. If no whitespace in stream, skip to end.

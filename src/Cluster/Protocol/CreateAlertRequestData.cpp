...
{
void CreateAlertRequestData::serialize(DB::WriteBuffer & wb, uint16_t /*version*/) const
{
...
void CreateAlertRequestData::doDeserialize(DB::ReadBuffer & rb, uint16_t /*version*/)
{
...
std::string CreateAlertRequestData::doString() const
{
    return fmt::format("{} requested_by={} initiator=0x{:x} timeout_ms={}", desc.string(), requested_by, initiator, timeout_ms);
}
}

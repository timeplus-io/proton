...
{
void CreateDatabaseResponseData::serialize(DB::WriteBuffer & wb, uint16_t /*version*/) const
{
...
void CreateDatabaseResponseData::doDeserialize(DB::ReadBuffer & rb, uint16_t /*version*/)
{
...
size_t CreateDatabaseResponseData::approximateSerializedSize() const noexcept
{
    return err.approximateSerializedSize() + sizeof(replica_leader) + sizeof(sn);
}

std::string CreateDatabaseResponseData::doString() const
{

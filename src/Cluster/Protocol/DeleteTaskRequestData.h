...
{
struct DeleteTaskRequestData final : public ProtocolData
{
public:
    /// Used for deserialization
    DeleteTaskRequestData() = default;
...
using DeleteTaskRequestDataPtr = std::shared_ptr<DeleteTaskRequestData>;
}

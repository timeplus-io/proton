...
{
void CreateDiskResponseData::serialize(DB::WriteBuffer & wb, uint16_t /*version*/) const
{
...
void CreateDiskResponseData::doDeserialize(DB::ReadBuffer & rb, uint16_t /*version*/)
{
...
size_t CreateDiskResponseData::approximateSerializedSize() const noexcept
{
    return err.approximateSerializedSize() + sizeof(replica_leader) + sizeof(sn);
}

std::string CreateDiskResponseData::doString() const
{

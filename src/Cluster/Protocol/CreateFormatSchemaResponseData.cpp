...
{
void CreateFormatSchemaResponseData::serialize(DB::WriteBuffer & wb, uint16_t /*version*/) const
{
...
void CreateFormatSchemaResponseData::doDeserialize(DB::ReadBuffer & rb, uint16_t /*version*/)
{
...
size_t CreateFormatSchemaResponseData::approximateSerializedSize() const noexcept
{
    if (err.hasError())
...
std::string CreateFormatSchemaResponseData::doString() const
{
    if (err.hasError())
        return err.string();

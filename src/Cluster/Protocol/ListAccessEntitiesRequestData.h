...
{
struct ListAccessEntitiesRequestData final : public ProtocolData
{
    /// Used for deserialization
    ListAccessEntitiesRequestData() = default;

    ListAccessEntitiesRequestData(cluster::NodeID initiator_, bool consistent_read_, int64_t timeout_ms_)
...
using ListAccessEntitiesRequestDataPtr = std::shared_ptr<ListAccessEntitiesRequestData>;
}

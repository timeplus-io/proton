...
flatbuffers::Offset<cluster::nlog::fbs::Record> createRecord(flatbuffers::FlatBufferBuilder & fbb, int8_t batch_delta, int8_t record_delta)
{
    /// Build header
    ...
    auto header = cluster::nlog::fbs::CreateRecordHeader(
        fbb,
    ...
    return cluster::nlog::fbs::CreateRecord(
        fbb,
...
flatbuffers::Offset<cluster::nlog::fbs::RecordBatch> createBatch(flatbuffers::FlatBufferBuilder & fbb, int8_t batch_delta)
{
    auto record1 = createRecord(fbb, batch_delta, 0);
    auto record2 = createRecord(fbb, batch_delta, 1);

    /// Build record batch
    return cluster::nlog::fbs::CreateRecordBatch(
        fbb,
        123 + batch_delta,
        2 + batch_delta,
        1000000 + batch_delta,
...
void validateBatch(const cluster::nlog::fbs::RecordBatch * batch, int8_t batch_delta)
{
...
{
    {
...

        {
            ...
            cluster::nlog::fbs::FinishSizePrefixedRecordBatchBuffer(fbb, batch);
    ...
    while (1)
    {
        ...
        auto batch = cluster::nlog::fbs::GetSizePrefixedRecordBatch(data.data() + consumed);

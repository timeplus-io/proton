...
#ifndef FLATBUFFERS_GENERATED_RECORD_CLUSTER_NLOG_FBS_H_
#define FLATBUFFERS_GENERATED_RECORD_CLUSTER_NLOG_FBS_H_
...
inline ::flatbuffers::Offset<RecordHeader> CreateRecordHeaderDirect(
  ...
  return cluster::nlog::fbs::CreateRecordHeader(
      _fbb,
      key__,
      value__);
}
...
struct Record FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>> *headers() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>> *>(VT_HEADERS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct RecordBuilder {
  ...
  void add_headers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>>> headers) {
...
inline ::flatbuffers::Offset<Record> CreateRecord(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<int8_t>> value = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>>> headers = 0) {
...
inline ::flatbuffers::Offset<Record> CreateRecordDirect(
    ...
    const std::vector<int8_t> *value = nullptr,
    const std::vector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>> *headers = nullptr) {
  auto key__ = key ? _fbb.CreateVector<int8_t>(*key) : 0;
  auto value__ = value ? _fbb.CreateVector<int8_t>(*value) : 0;
  auto headers__ = headers ? _fbb.CreateVector<::flatbuffers::Offset<cluster::nlog::fbs::RecordHeader>>(*headers) : 0;
...
struct RecordBatch FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::Record>> *records() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::Record>> *>(VT_RECORDS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct RecordBatchBuilder {
  ...
  void add_records(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::Record>>> records) {
...
inline ::flatbuffers::Offset<RecordBatch> CreateRecordBatch(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<cluster::nlog::fbs::Record>>> records = 0) {
...
inline ::flatbuffers::Offset<RecordBatch> CreateRecordBatchDirect(
    ...
    int16_t producer_epoch = 0,
    int32_t base_sequence = 0,
    const std::vector<::flatbuffers::Offset<cluster::nlog::fbs::Record>> *records = nullptr) {
  auto records__ = records ? _fbb.CreateVector<::flatbuffers::Offset<cluster::nlog::fbs::Record>>(*records) : 0;
...
inline const cluster::nlog::fbs::RecordBatch *GetRecordBatch(const void *buf) {
  return ::flatbuffers::GetRoot<cluster::nlog::fbs::RecordBatch>(buf);
}

inline const cluster::nlog::fbs::RecordBatch *GetSizePrefixedRecordBatch(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<cluster::nlog::fbs::RecordBatch>(buf);
}

inline bool VerifyRecordBatchBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<cluster::nlog::fbs::RecordBatch>(nullptr);
}

inline bool VerifySizePrefixedRecordBatchBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<cluster::nlog::fbs::RecordBatch>(nullptr);
}

inline void FinishRecordBatchBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<cluster::nlog::fbs::RecordBatch> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_RECORD_CLUSTER_NLOG_FBS_H_

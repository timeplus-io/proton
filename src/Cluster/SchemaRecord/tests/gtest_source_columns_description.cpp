...
constexpr auto Physical = cluster::SourceColumnsDescription::ReadColumnType::Physical;
constexpr auto Virtual = cluster::SourceColumnsDescription::ReadColumnType::Virtual;
constexpr auto Sub = cluster::SourceColumnsDescription::ReadColumnType::Sub;
...
TEST(SourceColumnsDescription, AllPhysical)
{
    ...
    cluster::SourceColumnsDescription columns_desc(columns_to_read, schema, all_extended_columns);
    /// Pos to read

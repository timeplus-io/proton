...
public:
    ...
    AppendResult append(SchemaRecord & record, const KafkaWALContext & ctx) const;
    ...
    int32_t append(SchemaRecord & record, AppendCallback callback, CallbackData data, const KafkaWALContext & ctx) const;
    ...
    int32_t commit(int64_t sn, const KafkaWALContext & ctx) const;
...
private:
    ...
    AppendResult handleError(int err, const SchemaRecord & record, const KafkaWALContext & ctx) const;
    ...
    int32_t doAppend(SchemaRecord & record, DeliveryReport * dr, const KafkaWALContext & walctx) const;

...
struct Record FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<nlog::fbs::RecordHeader>> *mutable_headers() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<nlog::fbs::RecordHeader>> *>(VT_HEADERS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct RecordBatch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::Vector<flatbuffers::Offset<nlog::fbs::Record>> *mutable_records() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<nlog::fbs::Record>> *>(VT_RECORDS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&

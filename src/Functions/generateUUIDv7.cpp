...
{
    static constexpr auto name = "generate_uuidv7_non_monotonic";
...
{
    static constexpr auto name = "generate_uuidv7";
...
{
    static constexpr auto name = "generate_uuidv7_thread_monotonic";
...
void registerUUIDv7Generator(auto& factory)
{
    ...
    FunctionDocumentation::Category doc_categories = {"UUID"};
...
REGISTER_FUNCTION(GenerateUUIDv7)
{
    ...
    /// proton: starts
    factory.registerAlias("uuid7", GlobalCounterPolicy::name, FunctionFactory::CaseInsensitive);
    /// proton: ends

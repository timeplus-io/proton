...
public:
    ...
    static constexpr auto name = exception_mode == IPStringToNumExceptionMode::Throw
        ? "to_ipv4"
        : (exception_mode == IPStringToNumExceptionMode::Default ? "to_ipv4_or_default" : "to_ipv4_or_null");
...
public:
    ...
    static constexpr auto name = exception_mode == IPStringToNumExceptionMode::Throw
        ? "to_ipv6"
        : (exception_mode == IPStringToNumExceptionMode::Default ? "to_ipv6_or_default" : "to_ipv6_or_null");

...
{
public:
    static constexpr auto name = is_utf8 ? "substring_utf8" : "substring";
...
{
    factory.registerFunction<FunctionSubstring<false>>(FunctionFactory::CaseSensitive);
    factory.registerAlias("substr", "substring", FunctionFactory::CaseSensitive);

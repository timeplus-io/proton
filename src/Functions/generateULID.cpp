...
public:
    ...
    static constexpr auto name = "generate_ulid";
...
The function returns a value of type fixed_string(26).
)",
        .examples{
            {"ulid", "SELECT generate_ulid()", ""},
            {"multiple", "SELECT generate_ulid(1), generate_ulid(2)", ""}},
            // proton: starts
            .category = "ULID"
            // proton:  ends
    });

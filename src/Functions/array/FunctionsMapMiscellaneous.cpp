...
struct NameMapAll { static constexpr auto name = "map_all"; };
using FunctionMapAll = FunctionMapToArrayAdapter<FunctionArrayAll, MapToNestedAdapter<NameMapAll, false>, NameMapAll>;

struct NameMapContainsKeyLike { static constexpr auto name = "map_contains_key_like"; };
...
struct NameMapExtractKeyLike { static constexpr auto name = "map_extract_key_like"; };
...
struct NameMapSort { static constexpr auto name = "map_sort"; };
struct NameMapReverseSort { static constexpr auto name = "map_reverse_sort"; };
struct NameMapPartialSort { static constexpr auto name = "map_partial_sort"; };
struct NameMapPartialReverseSort { static constexpr auto name = "map_partial_reverse_sort"; };
...
REGISTER_FUNCTION(MapMiscellaneous)
{
    ...
    FunctionDocumentation{
        .description="The same as array_concat.",
        .examples{{"map_concat", "SELECT map_concat(map_cast('k1', 'v1'), map_cast('k2', 'v2'))", ""}},
        .category{"Maps"},
    });
    ...
    factory.registerFunction<FunctionMapKeys>(
        FunctionDocumentation{
            ...
            .examples{{"map_keys", "SELECT map_keys(map_cast('k1', 'v1', 'k2', 'v2'))", ""}},
            .category{"Maps"},
        });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_values", "SELECT map_values(map_cast('k1', 'v1', 'k2', 'v2'))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_contains", "SELECT map_contains(map_cast('k1', 'v1', 'k2', 'v2'), 'k1')", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_filter", "SELECT map_filter((k, v) -> v > 1, map_cast('k1', 1, 'k2', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_apply", "SELECT map_apply((k, v) -> (k, v * 2), map_cast('k1', 1, 'k2', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_exists", "SELECT map_exists((k, v) -> v = 1, map_cast('k1', 1, 'k2', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_all", "SELECT map_all((k, v) -> v = 1, map_cast('k1', 1, 'k2', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_sort", "SELECT map_sort((k, v) -> v, map_cast('k1', 3, 'k2', 1, 'k3', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_reverse_sort", "SELECT map_reverse_sort((k, v) -> v, map_cast('k1', 3, 'k2', 1, 'k3', 2))", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_contains_key_like", "SELECT map_contains_key_like(map_cast('k1-1', 1, 'k2-1', 2), 'k1%')", ""}},
        .category{"Maps"},
    });
    ...
    FunctionDocumentation{
        ...
        .examples{{"map_extract_key_like", "SELECT map_extract_key_like(map_cast('k1-1', 1, 'k2-1', 2), 'k1%')", ""}},
        .category{"Maps"},
    });
}

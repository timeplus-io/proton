...
result: Row 1: [1, 2, 3], Row2: [4]
        ...
        if (!src_col)
            throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Illegal column {} in argument of function 'array_flatten'",
...
REGISTER_FUNCTION(ArrayFlatten)
{
    ...
    factory.registerAlias("flatten", "array_flatten", FunctionFactory::CaseSensitive);
}

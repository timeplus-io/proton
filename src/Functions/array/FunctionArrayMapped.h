...
/** Higher-order functions for arrays.
  ...
  * array_filter(x -> predicate, array) - leave in the array only the elements for which the expression is true.
  * It is possible for the functions to require fixed number of positional arguments:
  * array_partial_sort(limit, arr)
  * array_partial_sort(x -> predicate, limit, arr)
  *

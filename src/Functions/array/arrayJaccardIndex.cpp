...
public:
    static constexpr auto name = "array_jaccard_index";
    ...
    ColumnPtr executeImpl(const ColumnsWithTypeAndName & arguments, const DataTypePtr &, size_t input_rows_count) const override
    {
        ...
        auto intersect_array = FunctionFactory::instance().get("array_intersect", context)->build(arguments);
        ...
        if (!intersect_column_type)
            throw Exception(ErrorCodes::LOGICAL_ERROR, "Unexpected return type for function array_intersect");

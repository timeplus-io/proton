...
{
public:
    static constexpr auto name = "array_fold";
        ...
        for (size_t i = 1; i < arguments.size() - 1; ++i)
        {
            ...
            else
            {
                ...
                if (array_col_concrete->getOffsetsPtr() != first_array_col_offsets
                    ...
                    throw Exception(ErrorCodes::SIZES_OF_ARRAYS_DOESNT_MATCH, "arrays_data_with_type_and_name passed to {} must have equal size", getName());
            }

...
public:
    ...
    String getName() const override { return "grouping_ordinary"; }
...
public:
    ...
    String getName() const override { return "grouping_for_rollup"; }
...
public:
    ...
    String getName() const override { return "grouping_for_cube"; }
...
public:
    ...
    String getName() const override { return "grouping_for_grouping_sets"; }

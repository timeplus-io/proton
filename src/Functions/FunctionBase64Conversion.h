...
public:
    ...
    DataTypePtr getReturnTypeImpl(const ColumnsWithTypeAndName & arguments) const override
    {
        ...
        if (!WhichDataType(arguments[0].type).isStringOrFixedString())
            throw Exception(
                ...
                "Illegal type {} of 1st argument of function {}. Must be fixed_string or string.",
    ...
    ColumnPtr executeImpl(const ColumnsWithTypeAndName & arguments, const DataTypePtr &, const size_t input_rows_count) const override
    {
        ...
        throw Exception(
            ...
            "Illegal column {} of first argument of function {}, must be of type fixed_string or string.",

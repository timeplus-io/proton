...
{
    static constexpr auto name = "add_nanoseconds";
    ...
    {
        throw Exception("add_nanoseconds() cannot be used with date", ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT);
    }

    static inline NO_SANITIZE_UNDEFINED DateTime64 execute(Int32, Int64, const DateLUTImpl &, UInt16 = 0)
    {
        throw Exception("add_nanoseconds() cannot be used with date32", ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT);
    }
};

struct AddMicrosecondsImpl
{
    static constexpr auto name = "add_microseconds";
...
{
    static constexpr auto name = "add_milliseconds";
    ...
    static inline NO_SANITIZE_UNDEFINED DateTime64 execute(UInt16, Int64, const DateLUTImpl &, UInt16 = 0)
    {
        throw Exception("add_milliseconds() cannot be used with date", ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT);
    }
...
struct SubtractNanosecondsImpl : SubtractIntervalImpl<AddNanosecondsImpl> { static constexpr auto name = "subtract_nanoseconds"; };
struct SubtractMicrosecondsImpl : SubtractIntervalImpl<AddMicrosecondsImpl> { static constexpr auto name = "subtract_microseconds"; };
struct SubtractMillisecondsImpl : SubtractIntervalImpl<AddMillisecondsImpl> { static constexpr auto name = "subtract_milliseconds"; };

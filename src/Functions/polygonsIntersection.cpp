...
template <>
const char * FunctionPolygonsIntersection<CartesianPoint>::name = "polygons_intersection_cartesian";

template <>
const char * FunctionPolygonsIntersection<SphericalPoint>::name = "polygons_intersection_spherical";

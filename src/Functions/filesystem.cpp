...
{
    static constexpr auto name = "filesystem_unreserved";
...
public:
    ...
    DataTypePtr getReturnTypeImpl(const DataTypes & arguments) const override
    {
        ...
        {
            throw Exception(ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Arguments of function {} should be string or fixed_string",
                getName());
        }

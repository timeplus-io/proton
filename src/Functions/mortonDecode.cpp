...
{
public:
    static constexpr auto name = "morton_decode";
...
[example:from_table_range]
        ...
        Documentation::Examples{
            {"simple", "SELECT morton_decode(4, 2149)"},
            {"range_shrank", "SELECT morton_decode((1,2), 1572864)"},
            {"identity", "SELECT morton_decode(1, 1)"},
            {"identity_shrank", "SELECT morton_decode(tuple(2), 32768)"},
            {"from_table", "SELECT morton_decode(2, code) FROM table"},
            {"from_table_range", "SELECT morton_decode((1,2), code) FROM table"},
            },

...
/**
  * multi_fuzzy_match_any(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_fuzzy_match_any_index(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_fuzzy_match_all_indices(haystack, [pattern_1, pattern_2, ..., pattern_n])
  *
  */

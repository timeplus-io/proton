...
{
/**
  * multi_match_any(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_match_any_index(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_match_all_indices(haystack, [pattern_1, pattern_2, ..., pattern_n])
  *
  * multi_search_any(haystack, [pattern_1, pattern_2, ..., pattern_n]) -- find any of the const patterns inside haystack and return 0 or 1
  * multi_search_any_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_any_case_insensitive(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_any_case_insensitive_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])

  * multi_search_first_index(haystack, [pattern_1, pattern_2, ..., pattern_n]) -- returns the first index of the matched string or zero if nothing was found
  * multi_search_first_index_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_first_index_case_insensitive(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_first_index_case_insensitive_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  *
  * multi_search_first_position(haystack, [pattern_1, pattern_2, ..., pattern_n]) -- returns the leftmost offset of the matched string or zero if nothing was found
  * multi_search_first_position_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_first_position_case_insensitive(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_first_position_case_insensitive_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  */
...
public:
    ...
    ColumnPtr executeImpl(const ColumnsWithTypeAndName & arguments, const DataTypePtr &, size_t /*input_rows_count*/) const override
    {
        ...
        /// proton: starts.
        using ResultColumn
            = ColumnVector<std::conditional_t<std::is_same_v<typename Impl::ResultType, bool>, UInt8, typename Impl::ResultType>>;
        auto col_res = ResultColumn::create();
        /// proton: ends.

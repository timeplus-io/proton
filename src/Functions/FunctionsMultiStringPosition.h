...
{
/**
  * multi_search_all_positions(haystack, [pattern_1, pattern_2, ..., pattern_n]) -- find first occurrences (positions) of all the const patterns inside haystack
  * multi_search_all_positions_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_all_positions_case_insensitive(haystack, [pattern_1, pattern_2, ..., pattern_n])
  * multi_search_all_positions_case_insensitive_utf8(haystack, [pattern_1, pattern_2, ..., pattern_n])
  */

...
struct NameEncodeURLComponent { static constexpr auto name = "encode_url_component"; };
struct NameDecodeURLFormComponent { static constexpr auto name = "decode_url_form_component"; };
struct NameEncodeURLFormComponent { static constexpr auto name = "encode_url_form_component"; };

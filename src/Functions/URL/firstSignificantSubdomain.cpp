...
struct NameFirstSignificantSubdomainRFC { static constexpr auto name = "first_significant_subdomain_rfc"; };
...
The list of "insignificant" second-level domains and other implementation details may change in the future.
        ...
        Documentation::Examples{{"firstSignificantSubdomain", "SELECT first_significant_subdomain('https://news.clickhouse.com/')"}},

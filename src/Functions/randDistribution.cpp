...
struct UniformDistribution
{
    ...
    static constexpr const char * getName() { return "rand_uniform"; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_normal"; }
    static constexpr size_t getNumberOfArguments() { return 2; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_log_normal"; }
    static constexpr size_t getNumberOfArguments() { return 2; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_exponential"; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_chi_squared"; }
    static constexpr size_t getNumberOfArguments() { return 1; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_student_t"; }
    static constexpr size_t getNumberOfArguments() { return 1; }
...
{
    using ReturnType = DataTypeFloat64;
    static constexpr const char * getName() { return "rand_fisher_f"; }
    static constexpr size_t getNumberOfArguments() { return 2; }
...
struct BernoulliDistribution
{
    ...
    static constexpr const char * getName() { return "rand_bernoulli"; }
    static constexpr size_t getNumberOfArguments() { return 1; }
...
struct BinomialDistribution
{
    ...
    static constexpr const char * getName() { return "rand_binomial"; }
    static constexpr size_t getNumberOfArguments() { return 2; }
...
{
    using ReturnType = DataTypeUInt64;
    static constexpr const char * getName() { return "rand_negative_binomial"; }
    static constexpr size_t getNumberOfArguments() { return 2; }
...
{
    using ReturnType = DataTypeUInt64;
    static constexpr const char * getName() { return "rand_poisson"; }
    static constexpr size_t getNumberOfArguments() { return 1; }

...
struct NameReinterpretAsUInt8       { static constexpr auto name = "reinterpret_as_uint8"; };
struct NameReinterpretAsUInt16      { static constexpr auto name = "reinterpret_as_uint16"; };
struct NameReinterpretAsUInt32      { static constexpr auto name = "reinterpret_as_uint32"; };
struct NameReinterpretAsUInt64      { static constexpr auto name = "reinterpret_as_uint64"; };
struct NameReinterpretAsUInt128     { static constexpr auto name = "reinterpret_as_uint128"; };
struct NameReinterpretAsUInt256     { static constexpr auto name = "reinterpret_as_uint256"; };
struct NameReinterpretAsInt8        { static constexpr auto name = "reinterpret_as_int8"; };
struct NameReinterpretAsInt16       { static constexpr auto name = "reinterpret_as_int16"; };
struct NameReinterpretAsInt32       { static constexpr auto name = "reinterpret_as_int32"; };
struct NameReinterpretAsInt64       { static constexpr auto name = "reinterpret_as_int64"; };
struct NameReinterpretAsInt128      { static constexpr auto name = "reinterpret_as_int128"; };
struct NameReinterpretAsInt256      { static constexpr auto name = "reinterpret_as_int256"; };
struct NameReinterpretAsFloat32     { static constexpr auto name = "reinterpret_as_float32"; };
struct NameReinterpretAsFloat64     { static constexpr auto name = "reinterpret_as_float64"; };
struct NameReinterpretAsDate        { static constexpr auto name = "reinterpret_as_date"; };
struct NameReinterpretAsDateTime    { static constexpr auto name = "reinterpret_as_datetime"; };
struct NameReinterpretAsUUID        { static constexpr auto name = "reinterpret_as_uuid"; };
struct NameReinterpretAsString      { static constexpr auto name = "reinterpret_as_string"; };
struct NameReinterpretAsFixedString { static constexpr auto name = "reinterpret_as_fixed_string"; };

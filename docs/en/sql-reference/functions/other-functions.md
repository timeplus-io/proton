...
``` sql
structure_to_capn_proto_schema(structure)
```
...
``` sql
SELECT structure_to_capn_proto_schema('column1 string, column2 uint32, column3 array(string)') FORMAT RawBLOB
```
...
``` sql
SELECT structure_to_capn_proto_schema('column1 nullable(string), column2 tuple(element1 uint32, element2 array(string)), column3 map(string, string)') FORMAT RawBLOB
```
...
``` sql
SELECT structure_to_capn_proto_schema('column1 string, column2 uint32', 'Root') FORMAT RawBLOB
```
...
``` sql
structure_to_protobuf_schema(structure)
```
...
``` sql
SELECT structure_to_protobuf_schema('column1 string, column2 uint32, column3 array(string)') FORMAT RawBLOB
```
...
``` sql
SELECT structure_to_protobuf_schema('column1 nullable(string), column2 tuple(element1 uint32, element2 array(string)), column3 map(string, string)') FORMAT RawBLOB
```
...
``` sql
SELECT structure_to_protobuf_schema('column1 string, column2 uint32', 'Root') FORMAT RawBLOB
```

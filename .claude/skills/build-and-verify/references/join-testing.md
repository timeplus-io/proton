...
## Bidirectional mutable JOIN

```bash
# Setup
proton client --query "CREATE MUTABLE STREAM <id>_left(id int, value string) PRIMARY KEY id"
proton client --query "CREATE MUTABLE STREAM <id>_right(id int, name string) PRIMARY KEY id"

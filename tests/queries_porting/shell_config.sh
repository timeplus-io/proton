...
# [ -v CLICKHOUSE_USER_NAME ] && CLICKHOUSE_CLIENT_OPT0+=" --user=${CLICKHOUSE_USER_NAME} "
# [ -v CLICKHOUSE_USER_PASSWORD ] && CLICKHOUSE_CLIENT_OPT0+=" --password=${CLICKHOUSE_USER_PASSWORD} "

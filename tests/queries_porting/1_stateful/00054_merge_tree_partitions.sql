...
INSERT INTO test.partitions SELECT EventDate + UserID % 365 AS EventDate, CounterID from table(test.hits) WHERE CounterID = 1704509 AND toStartOfMonth(EventDate) = to_date('2014-03-01');

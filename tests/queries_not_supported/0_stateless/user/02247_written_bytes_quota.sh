...
${CLICKHOUSE_CLIENT} -q "DROP STREAM IF EXISTS written_bytes_02247"
...
${CLICKHOUSE_CLIENT} -q "CREATE STREAM written_bytes_02247(s string) ENGINE = Memory"
...
${CLICKHOUSE_CLIENT} -q "TRUNCATE STREAM written_bytes_02247"

${CLICKHOUSE_CLIENT} --user u02247 -q "INSERT INTO written_bytes_02247 SELECT to_string(number) FROM numbers(50)"
${CLICKHOUSE_CLIENT} --user u02247 -q "INSERT INTO written_bytes_02247 SELECT to_string(number) FROM numbers(100)" 2>&1 | grep -m1 -o QUOTA_EXCEEDED

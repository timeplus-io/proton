...
INSERT INTO bug_14144 SELECT cast(to_uuid_or_zero('2fc89389-4728-4b30-9e51-b5bc3ad215f6'), 'nullable(uuid)'), number, 'missing' FROM numbers(1000);

INSERT INTO bug_14144 SELECT cast(to_uuid_or_null('05fe40cb-1d0c-45b0-8e60-8e311c2463f1'), 'nullable(uuid)'), number, 'missing' FROM numbers(1000);

...
DROP STREAM IF EXISTS t_json_17;
SET allow_experimental_object_type = 1;
SET output_format_json_named_tuples_as_objects = 1;

CREATE STREAM t_json_17(obj JSON)
...
SELECT to_type_name(obj) FROM t_json_17 LIMIT 1;

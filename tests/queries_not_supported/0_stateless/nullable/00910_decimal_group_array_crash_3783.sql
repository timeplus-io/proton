select group_array(s) from (select sum(n) as  s from (select to_decimal32(1, 2) as n));
select group_array(s) from (select sum(n) as  s from (select to_decimal64(1, 5) as n));
select group_array(s) from (select sum(n) as  s from (select to_decimal128(1, 10) as n));

select group_array(s) from (select sum(n) as  s from (select to_decimal32(number, 2) as n from numbers(1000)));
select group_array(s) from (select sum(n) as  s from (select to_decimal64(number, 5) as n from numbers(1000)));
select group_array(s) from (select sum(n) as  s from (select to_decimal128(number, 10) as n from numbers(1000)));

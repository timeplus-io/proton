...
DROP STREAM IF EXISTS video_log_result__fuzz_0;
...
CREATE STREAM video_log_result__fuzz_0
(
...
DROP STREAM video_log;
DROP STREAM video_log_result__fuzz_0;
DROP STREAM rng;

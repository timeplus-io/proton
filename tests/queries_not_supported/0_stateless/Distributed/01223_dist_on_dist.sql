...
create stream dist_layer_01223 as data_01223 Engine=Distributed(test_cluster_two_shards, current_database(), data_01223);
create stream dist_01223 as data_01223 Engine=Distributed(test_cluster_two_shards, current_database(), dist_layer_01223);
...
select * from cluster(test_cluster_two_shards, current_database(), dist_01223) order by key;
select 'cluster() GROUP BY ORDER BY';
select * from cluster(test_cluster_two_shards, current_database(), dist_01223) group by key order by key;
...
create stream dist_layer_01223 as data_01223 Engine=Distributed(test_shard_localhost, current_database(), data_01223);
create stream dist_01223 as data_01223 Engine=Distributed(test_cluster_two_shards, current_database(), dist_layer_01223);
select count() from dist_01223;
...
-- wrap with merge()
select 'merge()';
create stream merge_dist_01223 as dist_01223 engine=Merge(current_database(), 'dist_01223');

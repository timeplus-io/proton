...
SELECT 'const column';
WITH to_datetime('2021-08-15 18:57:56', 'Asia/Shanghai') AS dt
SELECT dt, dateTimeToSnowflake(dt);

WITH to_datetime64('2021-08-15 18:57:56.492', 3, 'Asia/Shanghai') AS dt64
SELECT dt64, dateTime64ToSnowflake(dt64);

SELECT 'non-const column';
WITH to_datetime('2021-08-15 18:57:56', 'Asia/Shanghai') AS x
SELECT materialize(x) as dt, dateTimeToSnowflake(dt);;

WITH to_datetime64('2021-08-15 18:57:56.492', 3, 'Asia/Shanghai') AS x

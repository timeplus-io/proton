...
create stream quorum1(x uint32, y date) ENGINE ReplicatedMergeTree('/clickhouse/tables/{database}/test_00732/quorum_lost_alive', '1') ORDER BY x PARTITION BY y;
create stream quorum2(x uint32, y date) ENGINE ReplicatedMergeTree('/clickhouse/tables/{database}/test_00732/quorum_lost_alive', '2') ORDER BY x PARTITION BY y;
...
INSERT INTO quorum2 VALUES (4, to_date('2018-12-16')); -- { serverError 319 }

...
${CLICKHOUSE_CLIENT} --query="insert into stream function file('${FILE_PATH}/test_{_partition_id}', 'TSV', 'column1 uint32, column2 uint32, column3 uint32') PARTITION BY column3 values ${values}";
echo 'part 1'

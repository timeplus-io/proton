...
${CLICKHOUSE_CLIENT} --query "INSERT INTO STREAM FUNCTION file('test_02270_1.csv') SELECT 'Hello', 'World'"
${CLICKHOUSE_CLIENT} --query "INSERT INTO STREAM FUNCTION file('test_02270_2.csv') SELECT 'Error'"
...
${CLICKHOUSE_CLIENT} --query "INSERT INTO STREAM FUNCTION file('test_02270_1.csv.gz') SELECT 'Hello', 'World'"
${CLICKHOUSE_CLIENT} --query "INSERT INTO STREAM FUNCTION file('test_02270_2.csv.gz') SELECT 'Error'"

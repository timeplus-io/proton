...
SYSTEM FLUSH LOGS;
SELECT stream, part_name, event_type, merge_algorithm FROM system.part_log WHERE event_date >= yesterday() AND database = current_database() AND table = 'data_horizontal' ORDER BY event_time_microseconds;
...
SYSTEM FLUSH LOGS;
SELECT table, part_name, event_type, merge_algorithm FROM system.part_log WHERE event_date >= yesterday() AND database = current_database() AND table = 'data_vertical' ORDER BY event_time_microseconds;

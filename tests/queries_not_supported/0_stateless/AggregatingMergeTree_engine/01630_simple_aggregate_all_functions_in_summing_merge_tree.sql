DROP STREAM IF EXISTS simple_agf_aggregating_mt;

create stream simple_agf_aggregating_mt
(
    a int64,
...
OPTIMIZE STREAM simple_agf_aggregating_mt FINAL;
...
ALTER STREAM simple_agf_aggregating_mt
    DELETE WHERE (a % 3) = 0
...
DROP STREAM simple_agf_aggregating_mt;

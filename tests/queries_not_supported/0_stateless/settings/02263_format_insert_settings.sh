...
$CLICKHOUSE_CLIENT -q 'drop stream if exists data_02263'
$CLICKHOUSE_CLIENT -q 'create stream data_02263 (key int) engine=Memory()'
...
$CLICKHOUSE_CLIENT -q 'drop stream data_02263'

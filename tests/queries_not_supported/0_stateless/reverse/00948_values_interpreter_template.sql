...
--(1, lower( replace_all(_STR_1, 'o', 'a')), _NUM_1 + _NUM_2 + _NUM_3, round(_NUM_4 / _NUM_5), _NUM_6 * CAST(_STR_7, 'int8'), _ARR_8);
-- _NUM_1: uint64 -> int64 -> uint64
-- _NUM_4: int64 -> uint64
-- _NUM_5: float64 -> int64
INSERT INTO values_template VALUES ((1), lower( replace_all('Hella', 'a', 'o')), 1 + 2 + 3, round(-4 * 5.0), nan / CAST('42', 'int8'), reverse([1, 2, 3])), ((2), lower( replace_all('Warld', 'a', 'o')), -4 + 5 + 6, round(18446744073709551615 * 1e-19), 1.0 / CAST('0', 'int8'), reverse([])), ((3), lower( replace_all('Test', 'a', 'o')), 3 + 2 + 1, round(9223372036854775807 * -1), 6.28  / CAST('2', 'int8'), reverse([4, 5])), ((4), lower( replace_all('Expressians', 'a', 'o')), 6 + 5 + 4, round(1 * -9223372036854775807), 127.0 / CAST('127', 'int8'), reverse([6, 7, 8, 9, 0]));

INSERT INTO values_template_nullable VALUES ((1), lower( replace_all('Hella', 'a', 'o')), 1 + 2 + 3, arraySort(x -> assumeNotNull(x), [null, NULL])),   ((2), lower( replace_all('Warld', 'b', 'o')), 4 - 5 + 6, arraySort(x -> assumeNotNull(x), [+1, -1, Null])),   ((3), lower( replace_all('Test', 'c', 'o')), 3 + 2 - 1, arraySort(x -> assumeNotNull(x), [1, nUlL, 3.14])),   ((4), lower( replace_all(null, 'c', 'o')), 6 + 5 - null, arraySort(x -> assumeNotNull(x), [3, 2, 1]));

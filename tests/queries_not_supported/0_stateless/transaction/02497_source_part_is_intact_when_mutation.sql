...
DROP STREAM IF EXISTS t_source_part_is_intact;

CREATE STREAM t_source_part_is_intact (id uint64, u uint64)
...
ALTER STREAM t_source_part_is_intact update u = 0 where u != 0;
ROLLBACK;
...
ALTER STREAM t_source_part_is_intact update u = 1 WHERE 1;
ROLLBACK;

CHECK TABLE t_source_part_is_intact;

DETACH STREAM t_source_part_is_intact;
ATTACH STREAM t_source_part_is_intact;

CHECK TABLE t_source_part_is_intact;

DROP STREAM t_source_part_is_intact;

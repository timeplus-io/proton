...
SELECT sum_if(1, number % 2 > 2) FROM numbers(100);
SELECT sum_if(1 as one_expr, number % 2 > 2 as cond_expr), sum(cond_expr), one_expr FROM numbers(100);
SELECT count_if(number % 2 > 2) FROM numbers(100);

SELECT sum_if(1, number % 2 == 0) FROM numbers(100);
SELECT sum_if(1 as one_expr, number % 2 == 0 as cond_expr), sum(cond_expr), one_expr FROM numbers(100);
SELECT count_if(number % 2 == 0) FROM numbers(100);

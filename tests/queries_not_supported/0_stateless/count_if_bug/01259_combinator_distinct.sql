...
SELECT arraySort(group_array(DISTINCT number % 13)) FROM numbers_mt(100000);
SELECT finalizeAggregation(countState(DISTINCT to_string(number % 20))) FROM numbers_mt(100000);

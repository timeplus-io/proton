...
for STORAGE_POLICY in 's3_cache' 'local_cache' 'azure_cache'; do
    ...
    DROP STREAM IF EXISTS test_02226;
    CREATE STREAM test_02226 (key uint32, value string) Engine=MergeTree() ORDER BY key SETTINGS storage_policy='$STORAGE_POLICY';

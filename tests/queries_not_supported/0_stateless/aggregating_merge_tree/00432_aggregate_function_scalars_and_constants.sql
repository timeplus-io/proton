...
create stream agg_func_col (p date, k uint8, d aggregate_function(sum, uint64) DEFAULT arrayReduce('sumState', [to_uint64(200)])) ENGINE = AggregatingMergeTree(p, k, 1);
INSERT INTO agg_func_col (k) VALUES (0);
INSERT INTO agg_func_col (k, d) SELECT 1 AS k, arrayReduce('sumState', [to_uint64(100)]) AS d;
...
SELECT '';
ALTER STREAM agg_func_col ADD COLUMN af_gua aggregate_function(groupUniqArray, string) DEFAULT arrayReduce('groupUniqArrayState', ['---', '---']);

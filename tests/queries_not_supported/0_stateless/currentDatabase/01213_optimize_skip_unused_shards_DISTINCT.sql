...
create stream IF NOT EXISTS local_01213 (id int) ENGINE = MergeTree ORDER BY tuple();
create stream IF NOT EXISTS dist_01213 AS local_01213 ENGINE = Distributed(test_cluster_two_shards_localhost, currentDatabase(), local_01213, id);

-- at least two parts
INSERT INTO local_01213 SELECT to_string(number) FROM numbers(2);
INSERT INTO local_01213 SELECT to_string(number) FROM numbers(2);
...
DROP STREAM local_01213;
DROP STREAM dist_01213;

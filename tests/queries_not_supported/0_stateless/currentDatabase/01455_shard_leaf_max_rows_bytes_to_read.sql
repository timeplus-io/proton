...
create stream test_local (date date, value uint32) ENGINE = MergeTree(date, date, 8192);
create stream test_distributed AS test_local ENGINE = Distributed(test_cluster_two_shards, currentDatabase(), test_local, rand());

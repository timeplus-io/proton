...
$CLICKHOUSE_CLIENT --query="DROP STREAM IF EXISTS block_dedup_token SYNC"
$CLICKHOUSE_CLIENT --query="create stream block_dedup_token (id int32) ENGINE=MergeTree() ORDER BY id SETTINGS non_replicated_deduplication_window=0xFFFFFFFF;"
...
$CLICKHOUSE_CLIENT --query="DROP STREAM block_dedup_token SYNC"

...
${CLICKHOUSE_CLIENT} -q "create stream test_log_queries.logtable(i int, j int, k int) engine MergeTree order by i" "--query_id=01600_log_queries_with_extensive_info_002"
...
${CLICKHOUSE_CLIENT} -q "create stream test_log_queries.logtable2 as test_log_queries.logtable" "--query_id=01600_log_queries_with_extensive_info_007"
...
${CLICKHOUSE_CLIENT} -q "create stream test_log_queries.logtable3 engine MergeTree order by j as select * from test_log_queries.logtable" "--query_id=01600_log_queries_with_extensive_info_009"
${CLICKHOUSE_CLIENT} -q "alter stream test_log_queries.logtable rename column j to x, rename column k to y" "--query_id=01600_log_queries_with_extensive_info_010"
${CLICKHOUSE_CLIENT} -q "alter stream test_log_queries.logtable2 add column x int, add column y int" "--query_id=01600_log_queries_with_extensive_info_011"
${CLICKHOUSE_CLIENT} -q "alter stream test_log_queries.logtable3 drop column i, drop column k" "--query_id=01600_log_queries_with_extensive_info_012"
...
${CLICKHOUSE_CLIENT} -q "drop stream if exists test_log_queries.logtable" "--query_id=01600_log_queries_with_extensive_info_015"
${CLICKHOUSE_CLIENT} -q "drop stream if exists test_log_queries.logtable2" "--query_id=01600_log_queries_with_extensive_info_016"
${CLICKHOUSE_CLIENT} -q "drop stream if exists test_log_queries.logtable3" "--query_id=01600_log_queries_with_extensive_info_017"

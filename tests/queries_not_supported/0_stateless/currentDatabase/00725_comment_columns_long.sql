...
drop stream IF EXISTS check_query_comment_column;

-- Check COMMENT COLUMN and MODIFY COLUMN statements with simple engine
create stream check_query_comment_column
  (
...
SHOW create stream check_query_comment_column;
...
ALTER STREAM check_query_comment_column
...
-- Check `ALTER STREAM table_name COMMENT COLUMN 'comment'` statement with MergeTree engine
create stream check_query_comment_column
  (

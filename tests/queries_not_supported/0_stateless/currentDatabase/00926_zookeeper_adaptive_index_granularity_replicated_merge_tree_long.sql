...
DROP STREAM IF EXISTS zero_rows_per_granule1;
DROP STREAM IF EXISTS zero_rows_per_granule2;

create stream zero_rows_per_granule1 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
create stream zero_rows_per_granule2 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
OPTIMIZE STREAM zero_rows_per_granule2 FINAL;
...
DROP STREAM IF EXISTS four_rows_per_granule1;
DROP STREAM IF EXISTS four_rows_per_granule2;

create stream four_rows_per_granule1 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
create stream four_rows_per_granule2 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
OPTIMIZE STREAM four_rows_per_granule2 FINAL;
SELECT 'Parts optimized';
...
DROP STREAM IF EXISTS adaptive_granularity_alter1;
DROP STREAM IF EXISTS adaptive_granularity_alter2;

create stream adaptive_granularity_alter1 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
create stream adaptive_granularity_alter2 (
  p date,
  k uint64,
  v1 uint64,
  v2 Int64
...
ALTER STREAM adaptive_granularity_alter2 MODIFY COLUMN v1 Int16;
...
ALTER STREAM adaptive_granularity_alter1 MODIFY COLUMN v2 string;
...
OPTIMIZE STREAM adaptive_granularity_alter1 FINAL;
SELECT 'Parts optimized';

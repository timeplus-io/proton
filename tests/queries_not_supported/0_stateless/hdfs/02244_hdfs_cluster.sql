...
insert into stream function hdfs('hdfs://localhost:12222/test_1.tsv', 'TSV', 'column1 uint32, column2 uint32, column3 uint32') select 1, 2, 3 settings hdfs_truncate_on_insert=1;
insert into stream function hdfs('hdfs://localhost:12222/test_2.tsv', 'TSV', 'column1 uint32, column2 uint32, column3 uint32') select 4, 5, 6 settings hdfs_truncate_on_insert=1;
insert into stream function hdfs('hdfs://localhost:12222/test_3.tsv', 'TSV', 'column1 uint32, column2 uint32, column3 uint32') select 7, 8, 9 settings hdfs_truncate_on_insert=1;

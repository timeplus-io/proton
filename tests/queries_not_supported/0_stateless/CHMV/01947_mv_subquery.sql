...
create stream src Engine=MergeTree ORDER BY id AS SELECT number as id, to_int32(1) as value FROM numbers(1);
create stream dst (id uint64, delta int64) Engine=MergeTree ORDER BY id;

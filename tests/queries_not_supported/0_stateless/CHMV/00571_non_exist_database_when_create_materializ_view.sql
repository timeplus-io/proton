...
DROP STREAM IF EXISTS test_00571;
DROP STREAM IF EXISTS test_materialized_00571;

CREATE DATABASE none;
create stream test_00571 ( date date, platform Enum8('a' = 0, 'b' = 1, 'c' = 2), app Enum8('a' = 0, 'b' = 1) ) ENGINE = MergeTree(date, (platform, app), 8192);
...
DROP DATABASE IF EXISTS none;
DROP STREAM IF EXISTS test_00571.test_00571;
DROP STREAM IF EXISTS test_00571.test_materialized_00571;

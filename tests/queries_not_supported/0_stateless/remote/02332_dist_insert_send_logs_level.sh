...
$CLICKHOUSE_CLIENT --server_logs_file /dev/null -q "CREATE STREAM data_02332 (key int) Engine=Null()"
...
$CLICKHOUSE_CLIENT -q "INSERT INTO FUNCTION remote('127.2', current_database(), data_02332) SELECT * FROM numbers(10)" |& grep 'executeQuery.*initial_query_id.*INSERT INTO'
exit 0

...
DETACH STREAM table_with_lc_key;
ATTACH STREAM table_with_lc_key;
...
ALTER STREAM table_with_string_key MODIFY COLUMN str_key low_cardinality(string);

SHOW create stream table_with_string_key;

DETACH STREAM table_with_string_key;
ATTACH STREAM table_with_string_key;

...
RENAME STREAM test1601_detach_permanently_atomic.test_name_rename_attempt TO test1601_detach_permanently_atomic.test_name_reuse; -- { serverError 57 }
...
ATTACH STREAM test1601_detach_permanently_atomic.test_name_reuse UUID '00000000-0000-0000-0000-000000000001'　(`number` uint64　)　ENGINE = MergeTree　ORDER BY tuple()　SETTINGS index_granularity = 8192 ;  -- { serverError 57 }

SELECT 'can attach with short syntax';
ATTACH STREAM test1601_detach_permanently_atomic.test_name_reuse;
...
SELECT 'can not replace with the other table';
RENAME STREAM test1601_detach_permanently_ordinary.test_name_rename_attempt TO test1601_detach_permanently_ordinary.test_name_reuse; -- { serverError 57 }
...
ATTACH STREAM test1601_detach_permanently_ordinary.test_name_reuse (`number` uint64　)　ENGINE = MergeTree　ORDER BY tuple()　SETTINGS index_granularity = 8192;
DETACH table test1601_detach_permanently_ordinary.test_name_reuse PERMANENTLY;

SELECT 'can attach with short syntax';
ATTACH STREAM test1601_detach_permanently_ordinary.test_name_reuse;
...
SELECT 'can not replace with the other table';
RENAME STREAM test1601_detach_permanently_lazy.test_name_rename_attempt TO test1601_detach_permanently_lazy.test_name_reuse; -- { serverError 57 }

SELECT 'can still show the create statement';
SHOW create stream test1601_detach_permanently_lazy.test_name_reuse FORMAT Vertical;

SELECT 'can attach with full syntax';
ATTACH STREAM test1601_detach_permanently_lazy.test_name_reuse (`number` uint64　)　 ;
DETACH table test1601_detach_permanently_lazy.test_name_reuse PERMANENTLY;

SELECT 'can attach with short syntax';
ATTACH STREAM test1601_detach_permanently_lazy.test_name_reuse;

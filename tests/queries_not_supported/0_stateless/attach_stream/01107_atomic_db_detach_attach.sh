...
$CLICKHOUSE_CLIENT -q "DETACH STREAM test_01107.mt" --database_atomic_wait_for_drop_and_detach_synchronously=0
$CLICKHOUSE_CLIENT -q "ATTACH STREAM test_01107.mt" 2>&1 | grep -F "Code: 57" > /dev/null && echo "OK"
...
wait
$CLICKHOUSE_CLIENT -q "ATTACH STREAM test_01107.mt"

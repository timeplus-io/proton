...
CREATE STREAM fuse_tbl(a nullable(int32), b int32) Engine = Log;

INSERT INTO fuse_tbl SELECT number, number + 1 FROM numbers(1000);

SELECT quantile(0.8)(a), to_type_name(quantile(0.8)(a)), quantile(0.9)(a), to_type_name(quantile(0.9)(a)) FROM fuse_tbl;
SELECT quantile(0.8)(b), to_type_name(quantile(0.8)(b)), quantile(0.9)(b), to_type_name(quantile(0.9)(b)) FROM fuse_tbl;
SELECT quantile(0.8)(b), to_type_name(quantile(0.8)(b)), quantile(0.1)(b), to_type_name(quantile(0.1)(b)) FROM fuse_tbl;

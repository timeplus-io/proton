...
DROP STREAM IF EXISTS persons_00825;
DROP STREAM IF EXISTS roundtrip_persons_00825;
DROP STREAM IF EXISTS alt_persons_00825;
DROP STREAM IF EXISTS str_persons_00825;
DROP STREAM IF EXISTS syntax2_persons_00825;

create stream persons_00825 (uuid UUID,
                            name string,
                            surname string,
...
INSERT INTO persons_00825 VALUES (toUUID('a7522158-3d41-4b77-ad69-6c598ee55c49'), 'Ivan', 'Petrov', 'male', to_date('1980-12-29'), 'png', '+74951234567', 1, to_datetime('2019-01-05 18:45:00', 'Europe/Moscow'), 38, 'capricorn', ['Yesterday', 'Flowers'], [255, 0, 0], 'Moscow', [55.753215, 37.622504], 3.14, 214.10, 0.1, 5.8, 17060000000, ['meter', 'centimeter', 'kilometer'], [1, 0.01, 1000], 500, [501, 502]);
INSERT INTO persons_00825 VALUES (toUUID('c694ad8a-f714-4ea3-907d-fd54fb25d9b5'), 'Natalia', 'Sokolova', 'female', to_date('1992-03-08'), 'jpg', NULL, 0, NULL, 26, 'pisces', [], [100, 200, 50], 'Plymouth', [50.403724, -4.142123], 3.14159, NULL, 0.007, 5.4, -20000000000000, [], [], NULL, []);
INSERT INTO persons_00825 VALUES (toUUID('a7da1aa6-f425-4789-8947-b034786ed374'), 'Vasily', 'Sidorov', 'male', to_date('1995-07-28'), 'bmp', '+442012345678', 1, to_datetime('2018-12-30 00:00:00', 'Europe/Moscow'), 23, 'leo', ['Sunny'], [250, 244, 10], 'Murmansk', [68.970682, 33.074981], 3.14159265358979, 100000000000, 800, -3.2, 154400000, ['pound'], [16], 503, []);
...
echo
echo "Roundtrip:"
$CLICKHOUSE_CLIENT --query "create stream roundtrip_persons_00825 AS persons_00825"
...
echo
echo "Roundtrip:"
$CLICKHOUSE_CLIENT --query "create stream alt_persons_00825 AS persons_00825"
...
echo
echo "Roundtrip:"
$CLICKHOUSE_CLIENT --query "create stream str_persons_00825 AS persons_00825"
...
echo
echo "Roundtrip:"
$CLICKHOUSE_CLIENT --query "create stream syntax2_persons_00825 AS persons_00825"
...
$CLICKHOUSE_CLIENT --multiquery <<EOF
DROP STREAM persons_00825;
DROP STREAM roundtrip_persons_00825;
DROP STREAM alt_persons_00825;
DROP STREAM str_persons_00825;
DROP STREAM syntax2_persons_00825;
EOF

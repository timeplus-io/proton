...
ALTER STREAM table_for_rename_nested RENAME COLUMN n.renamed_x TO q.renamed_x; --{serverError 36}

ALTER STREAM table_for_rename_nested RENAME COLUMN value1 TO q.renamed_x; --{serverError 36}

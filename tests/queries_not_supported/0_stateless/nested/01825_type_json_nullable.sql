...
DROP STREAM IF EXISTS t_json_null;

create stream t_json_null(id uint64, data Object(Nullable('JSON')))
ENGINE = MergeTree ORDER BY tuple();

INSERT INTO t_json_null FORMAT JSONEachRow {"id": 1, "data": {"k1": 1, "k2" : 2}} {"id": 2, "data": {"k2": 3, "k3" : 4}};

SELECT id, data, to_type_name(data) FROM t_json_null ORDER BY id;

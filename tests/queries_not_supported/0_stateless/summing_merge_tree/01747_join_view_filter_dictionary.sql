-- Tags: no-parallel, not_supported, blocked_by_SummingMergeTree
SET query_mode = 'table';
drop stream if exists summing_table01747;
drop view if exists rates01747;
drop view if exists agg_view01747;
drop stream if exists dictst01747;
drop DICTIONARY if exists default.dict01747;

create stream summing_table01747
 (
    some_name               string,
    user_id                 uint64,
    amount                  int64,
...
create stream dictst01747(some_name string, field1 string, field2 uint8) Engine = Memory
...
drop stream summing_table01747;
drop view rates01747;
drop view agg_view01747;
drop stream dictst01747;

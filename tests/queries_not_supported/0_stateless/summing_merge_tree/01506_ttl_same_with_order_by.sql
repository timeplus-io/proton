...
DROP STREAM IF EXISTS derived_metrics_local;

create stream derived_metrics_local
(
  timestamp DateTime,
  bytes uint64
)
...
OPTIMIZE STREAM derived_metrics_local FINAL;
SELECT * FROM derived_metrics_local;

DROP STREAM derived_metrics_local;

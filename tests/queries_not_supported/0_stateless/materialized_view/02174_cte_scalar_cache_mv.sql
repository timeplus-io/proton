-- TEST CACHE
CREATE STREAM t1 (i int64, j int64) ENGINE = Memory;
INSERT INTO t1 SELECT number, number FROM system.numbers LIMIT 100;
CREATE STREAM t2 (k int64, l int64, m int64, n int64) ENGINE = Memory;

CREATE MATERIALIZED VIEW mv1 INTO t2 AS
    WITH
...
CREATE STREAM t3 (z int64) ENGINE = Memory;
CREATE MATERIALIZED VIEW mv2 INTO t3 AS
SELECT
...
CREATE STREAM t4 (z int64) ENGINE = Memory;
CREATE MATERIALIZED VIEW mv3 INTO t4 AS
SELECT

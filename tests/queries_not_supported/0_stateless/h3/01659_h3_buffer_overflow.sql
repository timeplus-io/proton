...
SELECT h3kRing(to_uint64(0xFFFFFFFF), 1000) FORMAT Null;
...
SELECT h3kRing(0xFFFFFFFFFFFFFF, to_uint16(10)) FORMAT Null;
SELECT h3ToGeo(0xFFFFFFFFFFFFFF) FORMAT Null;
SELECT h3HexRing(0xFFFFFFFFFFFFFF, to_uint16(10)) FORMAT Null; -- { serverError 117 }
SELECT h3HexRing(0xFFFFFFFFFFFFFF, to_uint16(10000)) FORMAT Null; -- { serverError 117 }
SELECT length(h3HexRing(581276613233082367, to_uint16(1))) FORMAT Null;

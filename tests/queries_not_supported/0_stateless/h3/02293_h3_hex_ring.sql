...
SELECT h3HexRing(581276613233082367, to_uint16(0));
SELECT h3HexRing(579205132326352334, to_uint16(1)) as hexRing; -- { serverError 117 }
SELECT h3HexRing(581276613233082367, -1); -- { serverError 43 }
SELECT h3HexRing(581276613233082367, to_uint16(-1)); -- { serverError 12 }
...
CREATE STREAM h3_indexes (h3_index uint64, k uint16) ENGINE = Memory;

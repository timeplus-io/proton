...
RENAME STREAM test_01114_1.mt_tmp TO test_01114_3.mt_tmp; /* move from Atomic to Ordinary */
RENAME STREAM test_01114_3.mt TO test_01114_1.mt;         /* move from Ordinary to Atomic */
...
$CLICKHOUSE_CLIENT -nm -q "
RENAME STREAM test_01114_1.mt TO test_01114_1.mt_tmp;
RENAME STREAM test_01114_1.mt_tmp TO test_01114_2.mt_tmp;
EXCHANGE TABLES test_01114_2.mt AND test_01114_2.mt_tmp;
RENAME STREAM test_01114_2.mt_tmp TO test_01114_1.mt;

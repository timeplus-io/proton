...
{
    while true; do
        $CLICKHOUSE_CLIENT -q "RENAME STREAM replica_01108_1 TO replica_01108_1_tmp,
...
{
    while true; do
        $CLICKHOUSE_CLIENT -q "RENAME STREAM replica_01108_1_tmp TO replica_01108_2,
...
$CLICKHOUSE_CLIENT -q "SELECT replace_one(name, '_tmp', '') FROM system.tables WHERE database = '$CLICKHOUSE_DATABASE' AND match(name, '^replica_01108_')"

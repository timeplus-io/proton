...
$CLICKHOUSE_CLIENT -q "DROP STREAM IF EXISTS t_json_15"
$CLICKHOUSE_CLIENT -q "CREATE STREAM t_json_15 (obj JSON) ENGINE = MergeTree ORDER BY tuple()" --allow_experimental_object_type 1
...
$CLICKHOUSE_CLIENT -q "SELECT DISTINCT to_type_name(obj) FROM t_json_15;"
...
$CLICKHOUSE_CLIENT -q "DROP STREAM t_json_15;"

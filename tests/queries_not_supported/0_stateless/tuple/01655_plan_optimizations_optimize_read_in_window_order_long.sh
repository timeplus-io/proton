...
$CLICKHOUSE_CLIENT -q "create stream ${name} engine=MergeTree order by tuple() as select to_int64((sin(number)+2)*65535)%500 as n, number as x from numbers_mt(5000000)"

...
select mapAdd(([1, 2], [to_float64(1.1), 1]), ([1, 2], [2.2, 1])) as res, to_type_name(res);
select mapAdd(([to_float32(1), 2], [to_float64(1.1), 1]), ([to_float32(1), 2], [2.2, 1])) as res, to_type_name(res); -- { serverError 43 }
select mapAdd(([1, 2], [to_float64(1.1), 1]), ([1, 2], [1, 1])) as res, to_type_name(res); -- { serverError 43 }
...
select mapAdd((cast(['a', 'b'], 'array(low_cardinality(string))'), [1, 1]), ([key], [1])) from values('key string', ('b'), ('c'), ('d'));

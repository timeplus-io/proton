...
DROP STREAM IF EXISTS test_01344;

create stream test_01344 (x string, INDEX idx (x) TYPE set(10) GRANULARITY 1) ENGINE = MergeTree ORDER BY tuple() SETTINGS min_bytes_for_wide_part = 0;

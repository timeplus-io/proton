CREATE TEMPORARY STREAM sessions (date DateTime, visitorId string, sessionId string);
CREATE TEMPORARY STREAM orders (date DateTime, visitorId string, orderId string);

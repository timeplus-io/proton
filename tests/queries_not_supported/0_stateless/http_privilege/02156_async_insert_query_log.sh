...
${CLICKHOUSE_CLIENT} -q "DROP STREAM IF EXISTS async_inserts_2156"
${CLICKHOUSE_CLIENT} -q "create stream async_inserts_2156 (id uint32, s string) "
...
${CLICKHOUSE_CLIENT} -q "SELECT query, array_exists(x -> x LIKE '%async_inserts_2156', tables), \
...
${CLICKHOUSE_CLIENT} -q "DROP STREAM async_inserts_2156"

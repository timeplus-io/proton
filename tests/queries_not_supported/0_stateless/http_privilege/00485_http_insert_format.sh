...
$CLICKHOUSE_CLIENT --query="DROP STREAM IF EXISTS format"
$CLICKHOUSE_CLIENT --query="create stream format (s string, x fixed_string(3)) "
...
$CLICKHOUSE_CLIENT --query="DROP STREAM format"

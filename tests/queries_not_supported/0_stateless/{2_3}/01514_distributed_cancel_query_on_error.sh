...
${CLICKHOUSE_CLIENT} "${opts[@]}" -q "SELECT group_array(repeat('a', if(_shard_num == 2, 100000, 1))), number%100000 k from remote('127.{2,3}', system.numbers) GROUP BY k LIMIT 10e6" |& {

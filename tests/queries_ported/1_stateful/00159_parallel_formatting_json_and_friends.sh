...
do
    ...
    "SELECT ClientEventTime::DateTime('Europe/Moscow') as a, MobilePhoneModel as b, ClientIP6 as c FROM table(test.hits) ORDER BY a, b, c LIMIT 3000000 Format $format" | md5sum

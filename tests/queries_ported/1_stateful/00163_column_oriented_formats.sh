...
do
    ...
    $CLICKHOUSE_CLIENT -q "INSERT INTO 00163_column_oriented SELECT ClientEventTime, MobilePhoneModel, ClientIP6 FROM table(test.hits) ORDER BY ClientEventTime, MobilePhoneModel, ClientIP6 LIMIT 100"

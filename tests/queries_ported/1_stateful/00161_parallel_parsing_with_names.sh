...
do
    ...
    "SELECT URLRegions as d, to_timezone(ClientEventTime, 'Europe/Moscow') as a, MobilePhoneModel as b, ParamPrice as e, ClientIP6 as c FROM table(test.hits) LIMIT 50000 Format $format" | \

...
FROM (
    SELECT
        null_if(to_bool(number % 3), 2) AS x1,
        null_if(to_bool(number / 3 % 3), 2) AS x2,
        null_if(to_bool(number / 9 % 3), 2) AS x3,
        null_if(to_bool(number / 27 % 3), 2) AS x4
    FROM numbers(81)
)
WHERE
...
FROM (
    SELECT
        ...
        null_if(to_bool(number / 9 % 3), 2) AS x3,
        null_if(to_bool(number / 27 % 3), 2) AS x4,
        null_if(to_bool(number / 81 % 3), 2) AS x5,
        null_if(to_bool(number / 243 % 3), 2) AS x6,
        null_if(to_bool(number / 729 % 3), 2) AS x7,
        null_if(to_bool(number / 2187 % 3), 2) AS x8,
        null_if(to_bool(number / 6561 % 3), 2) AS x9,
        null_if(to_bool(number / 19683 % 3), 2) AS x10,
        null_if(to_bool(number / 59049 % 3), 2) AS x11
    FROM numbers(177147)
)
WHERE
    (xor1 != xor2 OR (xor1 is NULL) != (xor2 is NULL)) OR

...
SELECT '---filter--';
SELECT array_filter(x -> false, empty_array_uint8());
SELECT array_filter(x -> false, [1, 2, 3]);
SELECT array_filter(x -> false, range(number)) FROM system.numbers LIMIT 10;
SELECT array_filter(x -> true, empty_array_uint8());
SELECT array_filter(x -> true, [1, 2, 3]);
SELECT array_filter(x -> true, range(number)) FROM system.numbers LIMIT 10;
SELECT '---count---';
...
SELECT '---filter--';
SELECT array_filter(x -> false, empty_array_string());
SELECT array_filter(x -> false, array_map(x -> to_string(x), [1, 2, 3]));
SELECT array_filter(x -> false, array_map(x -> to_string(x), range(number))) FROM system.numbers LIMIT 10;
SELECT array_filter(x -> true, empty_array_string());
SELECT array_filter(x -> true, array_map(x -> to_string(x), [1, 2, 3]));
SELECT array_filter(x -> true, array_map(x -> to_string(x), range(number))) FROM system.numbers LIMIT 10;
SELECT '---count---';

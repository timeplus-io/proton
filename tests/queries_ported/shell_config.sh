...
[ -n "${CLICKHOUSE_USER:-}" ] && CLICKHOUSE_CLIENT_OPT0+=" --user=${CLICKHOUSE_USER} "
[ -n "${CLICKHOUSE_PASSWORD:-}" ] && CLICKHOUSE_CLIENT_OPT0+=" --password=${CLICKHOUSE_PASSWORD} "
...
export CLICKHOUSE_PORT_TCP=${CLICKHOUSE_PORT_TCP:="8463"}

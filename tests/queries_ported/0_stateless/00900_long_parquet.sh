...
${CLICKHOUSE_CLIENT} -n --query="
    DROP STREAM IF EXISTS contributors;
    CREATE STREAM contributors (name string) ENGINE = Memory;"
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM contributors;

    DROP STREAM IF EXISTS parquet_numbers;
    CREATE STREAM parquet_numbers (number uint64) ENGINE = Memory;"
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    TRUNCATE STREAM parquet_numbers;"
...
${CLICKHOUSE_CLIENT} -n --query="
    SELECT * FROM parquet_numbers ORDER BY number DESC LIMIT 10;
    DROP STREAM parquet_numbers;

    DROP STREAM IF EXISTS parquet_events;
    CREATE STREAM parquet_events (event string, value uint64, description string) ENGINE = Memory;"
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM parquet_events;

    DROP STREAM IF EXISTS parquet_types1;
    DROP STREAM IF EXISTS parquet_types2;
    DROP STREAM IF EXISTS parquet_types3;
    DROP STREAM IF EXISTS parquet_types4;
    CREATE STREAM parquet_types1       (int8 int8, uint8 uint8, int16 int16, uint16 uint16, int32 int32, uint32 uint32, int64 int64, uint64 uint64, float32 float32, float64 float64, string string, fixedstring fixed_string(15), date Date, datetime DateTime('UTC'), datetime64 DateTime64(9, 'UTC')) ENGINE = Memory;
    CREATE STREAM parquet_types2       (int8 int8, uint8 uint8, int16 int16, uint16 uint16, int32 int32, uint32 uint32, int64 int64, uint64 uint64, float32 float32, float64 float64, string string, fixedstring fixed_string(15), date Date, datetime DateTime('UTC'), datetime64 DateTime64(9, 'UTC')) ENGINE = Memory;
    -- convert min type
    CREATE STREAM parquet_types3       (int8 int8,  uint8 int8,  int16 int8,   uint16 int8,  int32 int8,   uint32 int8,  int64 int8,   uint64 int8,    float32 int8,    float64 int8, string fixed_string(15), fixedstring fixed_string(15), date Date, datetime Date, datetime64 DateTime64(9, 'UTC')) ENGINE = Memory;
    -- convert max type
    CREATE STREAM parquet_types4       (int8 int64, uint8 int64, int16 int64, uint16 int64, int32 int64,  uint32 int64, int64 int64,  uint64 int64,   float32 int64,   float64 int64, string string,          fixedstring string, date DateTime('UTC'), datetime DateTime('UTC'), datetime64 DateTime64(9, 'UTC')) ENGINE = Memory;
...
${CLICKHOUSE_CLIENT} -n --query="
    TRUNCATE STREAM parquet_types2;
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM IF EXISTS parquet_types5;
    DROP STREAM IF EXISTS parquet_types6;
    TRUNCATE STREAM parquet_types2;
    CREATE STREAM parquet_types5       (int8 nullable(int8), uint8 nullable(uint8), int16 nullable(int16), uint16 nullable(uint16), int32 nullable(int32), uint32 nullable(uint32), int64 nullable(int64), uint64 nullable(uint64), float32 nullable(float32), float64 nullable(float64), string nullable(string), fixedstring nullable(fixed_string(15)), date nullable(Date), datetime nullable(DateTime('UTC')), datetime64 nullable(DateTime64(9, 'UTC'))) ENGINE = Memory;
    CREATE STREAM parquet_types6       (int8 nullable(int8), uint8 nullable(uint8), int16 nullable(int16), uint16 nullable(uint16), int32 nullable(int32), uint32 nullable(uint32), int64 nullable(int64), uint64 nullable(uint64), float32 nullable(float32), float64 nullable(float64), string nullable(string), fixedstring nullable(fixed_string(15)), date nullable(Date), datetime nullable(DateTime('UTC')), datetime64 nullable(DateTime64(9, 'UTC'))) ENGINE = Memory;
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM parquet_types5;
    DROP STREAM parquet_types6;

    DROP STREAM parquet_types1;
    DROP STREAM parquet_types2;
    DROP STREAM parquet_types3;
    DROP STREAM parquet_types4;

    DROP STREAM IF EXISTS parquet_arrays;

    CREATE STREAM parquet_arrays (id uint32, a1 array(int8), a2 array(uint8), a3 array(int16), a4 array(uint16), a5 array(int32), a6 array(uint32), a7 array(int64), a8 array(uint64), a9 array(string), a10 array(fixed_string(4)), a11 array(float32), a12 array(float64), a13 array(Date), a14 array(DateTime('UTC')), a15 array(Decimal(4, 2)), a16 array(Decimal(10, 2)), a17 array(Decimal(25, 2))) engine=Memory();
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM parquet_arrays;

    DROP STREAM IF EXISTS parquet_nullable_arrays;
    CREATE STREAM parquet_nullable_arrays (id uint32, a1 array(nullable(uint32)), a2 array(nullable(string)), a3 array(nullable(Decimal(4, 2)))) engine=Memory();
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM parquet_nullable_arrays;

    DROP STREAM IF EXISTS parquet_nested_arrays;
    CREATE STREAM parquet_nested_arrays (a1 array(array(array(uint32))), a2 array(array(array(string))), a3 array(array(nullable(uint32))), a4 array(array(nullable(string)))) engine=Memory();
...
${CLICKHOUSE_CLIENT} -n --query="
    ...
    DROP STREAM parquet_nested_arrays;

    DROP STREAM IF EXISTS parquet_decimal;
    CREATE STREAM parquet_decimal (d1 Decimal32(4), d2 Decimal64(8), d3 Decimal128(16), d4 Decimal256(32)) ENGINE = Memory;
    INSERT INTO parquet_decimal VALUES (0.123, 0.123123123, 0.123123123123, 0.123123123123123123);"

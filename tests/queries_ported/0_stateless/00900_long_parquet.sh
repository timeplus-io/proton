#!/usr/bin/env bash
# Tags: long, no-fasttest, no-python
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_numbers (number uint64) ENGINE = Memory"
...
${CLICKHOUSE_CLIENT} --query="TRUNCATE STREAM parquet_numbers"
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_events (event string, value uint64, description string) ENGINE = Memory"
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_types1       (int8 int8, uint8 uint8, int16 int16, uint16 uint16, int32 int32, uint32 uint32, int64 int64, uint64 uint64, float32 float32, float64 float64, string string, fixedstring fixed_string(15), date date, datetime datetime, datetime64 datetime64(9)) ENGINE = Memory"
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_types2       (int8 int8, uint8 uint8, int16 int16, uint16 uint16, int32 int32, uint32 uint32, int64 int64, uint64 uint64, float32 float32, float64 float64, string string, fixedstring fixed_string(15), date date, datetime datetime, datetime64 datetime64(9)) ENGINE = Memory"
# convert min type
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_types3       (int8 int8,  uint8 int8,  int16 int8,   uint16 int8,  int32 int8,   uint32 int8,  int64 int8,   uint64 int8,    float32 int8,    float64 int8, string fixed_string(15), fixedstring fixed_string(15), date date, datetime date, datetime64 datetime64(9)) ENGINE = Memory"
# convert max type
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_types4       (int8 int64, uint8 int64, int16 int64, uint16 int64, int32 int64,  uint32 int64, int64 int64,  uint64 int64,   float32 int64,   float64 int64, string string,          fixedstring string, date datetime, datetime datetime, datetime64 datetime64(9)) ENGINE = Memory"

${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_types1 values (     -108,         108,       -1016,          1116,       -1032,          1132,       -1064,          1164,          -1.032,          -1.064,    'string-0',               'fixedstring', '2001-02-03', '2002-02-03 04:05:06', to_datetime64('2002-02-03 04:05:06.789', 9))"

# min
${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_types1 values (     -128,           0,      -32768,             0, -2147483648,             0, -9223372036854775808, 0,             -1.032,          -1.064,    'string-1',             'fixedstring-1', '2003-04-05', '2003-02-03 04:05:06', to_datetime64('2003-02-03 04:05:06.789', 9))"

# max
${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_types1 values (      127,         255,       32767,         65535,  2147483647,    4294967295, 9223372036854775807, 9223372036854775807, -1.032,     -1.064,    'string-2',             'fixedstring-2', '2004-06-07', '2004-02-03 04:05:06', to_datetime64('2004-02-03 04:05:06.789', 9))"
...
${CLICKHOUSE_CLIENT} --query="TRUNCATE STREAM parquet_types2"
${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_types3 values (       79,          81,          82,            83,          84,            85,          86,            87,              88,              89,         'str01',                  'fstr1', '2003-03-04', '2004-05-06', to_datetime64('2004-05-06 07:08:09.012', 9))"
...
${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_types4 values (       80,          81,          82,            83,          84,            85,          86,            87,              88,              89,         'str02',                  'fstr2', '2005-03-04 05:06:07', '2006-08-09 10:11:12', to_datetime64('2006-08-09 10:11:12.345', 9))"
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM parquet_decimal (d1 decimal32(4), d2 decimal64(8), d3 decimal128(16), d4 decimal256(32)) ENGINE = Memory"
${CLICKHOUSE_CLIENT} --query="INSERT INTO parquet_decimal VALUES (0.123, 0.123123123, 0.123123123123, 0.123123123123123123)"

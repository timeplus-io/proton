...
create stream sample_merge_tree (dt datetime, x uint64) ENGINE = MergeTree PARTITION BY to_YYYYMMDD(dt) ORDER BY x SETTINGS min_merge_bytes_to_use_direct_io=1, index_granularity = 8192;

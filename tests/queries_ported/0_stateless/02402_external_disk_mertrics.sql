...
SELECT
    ...
    count() == 1
    FROM system.query_log WHERE current_database = current_database()
...
SELECT number * 200000 as n, j * 2097152 FROM numbers(5) as nums
ANY LEFT JOIN ( SELECT number * 2 AS n, number AS j FROM numbers(1000000) ) as js2
USING n
ORDER BY n

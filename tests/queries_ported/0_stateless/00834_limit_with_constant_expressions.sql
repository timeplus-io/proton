...
SELECT number FROM numbers(10) LIMIT to_uint8('1');
SELECT number FROM numbers(10) LIMIT to_float32('1');
SELECT number FROM numbers(10) LIMIT rand(); -- { serverError 36 }

SELECT count() <= 1 FROM (SELECT number FROM numbers(10) LIMIT rand_constant() % 2);
...
SELECT * FROM numbers(10) LIMIT LENGTH('NNN') + COS(0), to_date('0000-00-02'); -- { serverError 440 }
SELECT * FROM numbers(10) LIMIT LENGTH('NNN') + COS(0), to_date('0000-00-02'); -- { serverError 440 }

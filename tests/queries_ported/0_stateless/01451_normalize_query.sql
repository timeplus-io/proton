...
SELECT normalize_query('SELECT $doc$VALUE$doc$, xyz11');
SELECT normalize_query('SELECT $doc$VALUE$doc$, ''xyz11''');
SELECT normalize_query('1 - 2');
SELECT normalize_query('1, -2, 3');
SELECT normalize_query('-1, -2, 3');
SELECT normalize_query('1 - 2, 3, 4');
SELECT normalize_query('f(-2, 3)');
SELECT normalize_query('[-1, 2, 3]');
SELECT normalize_query('1 + 2');
SELECT normalize_query('1, +2, 3');
SELECT normalize_query('-1, +2, 3');
...
SELECT normalize_query('1, 2, 3 + 4');
SELECT normalize_query('1, 2 - 3, 4');
SELECT normalize_query('f(+2, 3), 1');
SELECT normalize_query('[+1, 2, 3] - 1');
SELECT normalize_query('-1, 1 - [+1, 2, 3] - 1');
SELECT normalize_query('(+1, 2, 3) - 1');
SELECT normalize_query('-1, 1 - (+1, 2, 3) - 1');
SELECT normalize_query('(+1, 2, -3)');

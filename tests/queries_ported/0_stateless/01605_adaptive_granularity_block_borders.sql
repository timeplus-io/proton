...
INSERT INTO adaptive_table SELECT number, if(number > 700, random_printable_ascii(102400), random_printable_ascii(1)) FROM numbers(10000);

OPTIMIZE STREAM adaptive_table FINAL;

SELECT marks FROM system.parts WHERE table = 'adaptive_table' and database=current_database() and active;

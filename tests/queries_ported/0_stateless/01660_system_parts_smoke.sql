...
-- Empty
SELECT _state FROM system.parts WHERE database = current_database() AND table = 'data_01660';
SELECT name, _state FROM system.parts WHERE database = current_database() AND table = 'data_01660';
SELECT name, active FROM system.parts WHERE database = current_database() AND table = 'data_01660';
...
SELECT count(), _state FROM system.parts WHERE database = current_database() AND table = 'data_01660' GROUP BY _state ORDER BY _state;
...
SELECT '# truncate';
TRUNCATE data_01660;
SELECT if (count() > 0, 'HAVE PARTS', 'NO PARTS'), _state FROM system.parts WHERE database = current_database() AND table = 'data_01660' GROUP BY _state;

-- But DROP does
SELECT '# drop';
DROP STREAM data_01660;
SELECT * FROM system.parts WHERE database = current_database() AND table = 'data_01660';

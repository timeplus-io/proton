...
CREATE STREAM rename_table_multiple (key int32, value1 string, value2 int32) ENGINE = MergeTree ORDER BY tuple_cast() SETTINGS min_bytes_for_wide_part=0;

INSERT INTO rename_table_multiple VALUES (1, 2, 3);

ALTER STREAM rename_table_multiple RENAME COLUMN value1 TO value1_string, MODIFY COLUMN value1_string string; --{serverError NOT_IMPLEMENTED}
ALTER STREAM rename_table_multiple MODIFY COLUMN value1 string, RENAME COLUMN value1 to value1_string; --{serverError NOT_IMPLEMENTED}
...
CREATE STREAM rename_table_multiple_compact (key int32, value1 string, value2 int32) ENGINE = MergeTree ORDER BY tuple_cast() SETTINGS min_rows_for_wide_part = 100000;

INSERT INTO rename_table_multiple_compact VALUES (1, 2, 3);

ALTER STREAM rename_table_multiple_compact RENAME COLUMN value1 TO value1_string, MODIFY COLUMN value1_string string; --{serverError NOT_IMPLEMENTED}
ALTER STREAM rename_table_multiple_compact MODIFY COLUMN value1 string, RENAME COLUMN value1 to value1_string; --{serverError NOT_IMPLEMENTED}

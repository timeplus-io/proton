...
SELECT avg_time_weighted(val, a) FROM (SELECT * FROM table(test_99010) ORDER BY a);
SELECT avg_time_weighted(val, b) FROM (SELECT * FROM table(test_99010) ORDER BY b);
SELECT avg_time_weighted(val, c) FROM (SELECT * FROM table(test_99010) ORDER BY c);
SELECT avg_time_weighted(val, d) FROM (SELECT * FROM table(test_99010) ORDER BY d);
DROP STREAM IF EXISTS test_99010;

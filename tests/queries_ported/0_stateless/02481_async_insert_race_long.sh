...
${CLICKHOUSE_CLIENT} -q "DROP STREAM IF EXISTS async_inserts_race"
${CLICKHOUSE_CLIENT} -q "CREATE STREAM async_inserts_race (id uint32, s string) ENGINE = MergeTree ORDER BY id"

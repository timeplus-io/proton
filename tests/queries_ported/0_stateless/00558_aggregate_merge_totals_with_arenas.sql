 ...
 *  because aggregate functions min/max/any/any_last use Arena only for long enough strings.
 *
 * And we use function 'any_last' for method IAggregateFunction::merge to be called for every new value.
 *
 ...
 * max_threads = 1 for deterministic order of result in subquery and the value of 'any_last'.
 */

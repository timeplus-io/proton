...
${CLICKHOUSE_CLIENT} -q "DROP STREAM IF EXISTS t_async_insert_02193_2"

${CLICKHOUSE_CLIENT} -q "CREATE STREAM t_async_insert_02193_2 (id uint32, s string) ENGINE = Memory"
...
${CLICKHOUSE_CLIENT} -q "TRUNCATE STREAM t_async_insert_02193_2"

...
CREATE STREAM lc_nullable (
    ...
    date_time array(low_cardinality(nullable(DateTime('Asia/Istanbul')))),
...
INSERT INTO lc_nullable SELECT
    ...
    group_array(to_date(number, 'Asia/Istanbul')) AS date,
    group_array(to_datetime(number, 'Asia/Istanbul')) AS date_time,
...
INSERT INTO lc_nullable SELECT
    ...
    group_array(to_date(num, 'Asia/Istanbul')) AS date,
    group_array(to_datetime(num, 'Asia/Istanbul')) AS date_time,
...
INSERT INTO lc_nullable SELECT
    ...
    [NULL, to_date(n, 'Asia/Istanbul')] AS date,
    [NULL, to_datetime(n, 'Asia/Istanbul')] AS date_time,
...
SELECT count() FROM lc_nullable WHERE has(date_time, to_datetime('1970-01-01 02:00:01', 'Asia/Istanbul'));
...
SELECT count() FROM lc_nullable WHERE has(date_time, to_datetime('1970-01-01 02:00:05', 'Asia/Istanbul'));
...
SELECT count() FROM lc_nullable WHERE has(date_time, to_datetime('1970-01-01 02:00:10', 'Asia/Istanbul'));
...
SELECT count() FROM lc_nullable WHERE has(date_time, to_datetime('1970-01-01 02:01:40', 'Asia/Istanbul'));

...
SELECT 2+1 FROM system.one as X RIGHT JOIN system.one as Y ON X.dummy+1 = Y.dummy SETTINGS join_use_nulls = 1;
SELECT 2+1 FROM system.one as X RIGHT JOIN system.one as Y ON X.dummy+1 = to_uint16(Y.dummy) SETTINGS join_use_nulls = 1;
SELECT X.dummy+1 FROM system.one as X RIGHT JOIN system.one as Y ON X.dummy = Y.dummy SETTINGS join_use_nulls = 1;
SELECT Y.dummy+1 FROM system.one as X RIGHT JOIN system.one as Y ON X.dummy = Y.dummy SETTINGS join_use_nulls = 1;

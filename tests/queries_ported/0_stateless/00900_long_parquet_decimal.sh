...
# Simple small values
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal  (a decimal(9,0), b decimal(18,0), c decimal(38,0), d decimal(9, 9), e decimal(18, 18), f decimal(38, 38), g decimal(9, 5), h decimal(18, 9), i decimal(38, 18), j decimal(1,0)) ENGINE = Memory;"
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal2 (a decimal(9,0), b decimal(18,0), c decimal(38,0), d decimal(9, 9), e decimal(18, 18), f decimal(38, 38), g decimal(9, 5), h decimal(18, 9), i decimal(38, 18), j decimal(1,0)) ENGINE = Memory;"
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal  (a decimal(9,0), b decimal(18,0), c decimal(38,0), d decimal(9, 9), e decimal64(18), f decimal128(38), g decimal32(5), h decimal64(9), i decimal128(18), j decimal(4,2)) ENGINE = Memory;"
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal2 (a decimal(9,0), b decimal(18,0), c decimal(38,0), d decimal(9, 9), e decimal64(18), f decimal128(38), g decimal32(5), h decimal64(9), i decimal128(18), j decimal(4,2)) ENGINE = Memory;"
...
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal  (a nullable(decimal(9,0)), b nullable(decimal(18,0)), c nullable(decimal(38,0)), d nullable(decimal(9,0))) ENGINE = Memory;"
${CLICKHOUSE_CLIENT} --query="CREATE STREAM IF NOT EXISTS decimal2 (a nullable(decimal(9,0)), b nullable(decimal(18,0)), c nullable(decimal(38,0)), d nullable(decimal(9,0))) ENGINE = Memory;"
# Empty table test
...
${CLICKHOUSE_CLIENT} --query="TRUNCATE STREAM decimal2;"

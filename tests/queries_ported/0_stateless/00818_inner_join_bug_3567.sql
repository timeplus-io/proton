...
SELECT * FROM stream1 as t1 FORMAT PrettyCompact;
SELECT *, c as a, d as b FROM stream2 FORMAT PrettyCompact;
SELECT * FROM stream1 as t1 ALL LEFT JOIN (SELECT *, c, d as b FROM stream2) as t2 USING (a, b) ORDER BY d, t1.a FORMAT PrettyCompact;
SELECT * FROM stream1 as t1 ALL INNER JOIN (SELECT *, c, d as b FROM stream2) as t2 USING (a, b) ORDER BY d, t1.a FORMAT PrettyCompact;

...
do
    ...
    $CLICKHOUSE_CLIENT -q "TRUNCATE STREAM test_02117"
done
...
$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x, 'text' AS y, to_date16('2020-01-01') AS z FORMAT CustomSeparatedWithNames $CUSTOM_SETTINGS" | \
...
$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x, 'text' AS y, to_date16('2020-01-01') AS z FORMAT CustomSeparatedWithNamesAndTypes $CUSTOM_SETTINGS" | \
...
$CLICKHOUSE_CLIENT -q "SELECT 'text' AS y, to_date16('2020-01-01') AS z, to_uint32(1) AS x FORMAT CustomSeparatedWithNames $CUSTOM_SETTINGS" | \
    $CLICKHOUSE_CLIENT --input_format_with_names_use_header=1 -q "INSERT INTO test_02117 $CUSTOM_SETTINGS FORMAT CustomSeparatedWithNames"
$CLICKHOUSE_CLIENT -q "SELECT * FROM test_02117"
$CLICKHOUSE_CLIENT -q "TRUNCATE STREAM test_02117"

$CLICKHOUSE_CLIENT -q "SELECT 'text' AS y, to_date16('2020-01-01') AS z, to_uint32(1) AS x FORMAT CustomSeparatedWithNamesAndTypes $CUSTOM_SETTINGS" | \
    $CLICKHOUSE_CLIENT --input_format_with_names_use_header=1 --input_format_with_types_use_header=1 -q "INSERT INTO test_02117 $CUSTOM_SETTINGS FORMAT CustomSeparatedWithNamesAndTypes"
$CLICKHOUSE_CLIENT -q "SELECT * FROM test_02117"
$CLICKHOUSE_CLIENT -q "TRUNCATE STREAM test_02117"


$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x FORMAT CustomSeparatedWithNames $CUSTOM_SETTINGS" | \
    $CLICKHOUSE_CLIENT --input_format_with_names_use_header=1 -q "INSERT INTO test_02117 $CUSTOM_SETTINGS FORMAT CustomSeparatedWithNames"
$CLICKHOUSE_CLIENT -q "SELECT * FROM test_02117"
$CLICKHOUSE_CLIENT -q "TRUNCATE STREAM test_02117"

$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x FORMAT CustomSeparatedWithNamesAndTypes  $CUSTOM_SETTINGS" | \
    $CLICKHOUSE_CLIENT --input_format_with_names_use_header=1 --input_format_with_types_use_header=1 -q "INSERT INTO test_02117 $CUSTOM_SETTINGS FORMAT CustomSeparatedWithNamesAndTypes"
$CLICKHOUSE_CLIENT -q "SELECT * FROM test_02117"
$CLICKHOUSE_CLIENT -q "TRUNCATE STREAM test_02117"
...
$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x, [[1, 2, 3], [4, 5], []] as a FORMAT CustomSeparatedWithNames $CUSTOM_SETTINGS" | \
...
$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x, [[1, 2, 3], [4, 5], []] as a FORMAT CustomSeparatedWithNamesAndTypes $CUSTOM_SETTINGS" | \
...
$CLICKHOUSE_CLIENT -q "SELECT 'text' AS x, to_date16('2020-01-01') AS y, to_uint32(1) AS z FORMAT CustomSeparatedWithNamesAndTypes $CUSTOM_SETTINGS" > $TMP_FILE
...
$CLICKHOUSE_CLIENT -q "SELECT to_uint32(1) AS x, 'text' as z, to_date16('2020-01-01') AS y FORMAT CustomSeparatedWithNamesAndTypes $CUSTOM_SETTINGS" > $TMP_FILE
cat $TMP_FILE | $CLICKHOUSE_CLIENT --input_format_with_names_use_header=1 --input_format_with_types_use_header=1 -q "INSERT INTO test_02117 $CUSTOM_SETTINGS FORMAT CustomSeparatedWithNamesAndTypes" 2>&1 | \
    grep -F -q "INCORRECT_DATA" && echo 'OK' || echo 'FAIL'

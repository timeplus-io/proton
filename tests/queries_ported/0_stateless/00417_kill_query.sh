...
$CLICKHOUSE_CLIENT -q "KILL QUERY WHERE false ASYNC"
$CLICKHOUSE_CLIENT -q "KILL QUERY WHERE false FORMAT TabSeparated"
$CLICKHOUSE_CLIENT -q "KILL QUERY WHERE false SYNC FORMAT TabSeparated"
$CLICKHOUSE_CLIENT -q "KILL QUERY WHERE true TEST" &>/dev/null

...
CREATE STREAM test_null_as_default (a string DEFAULT 'WORLD') ENGINE = Memory;
...
DROP STREAM IF EXISTS test_null_as_default;
CREATE STREAM test_null_as_default (a string DEFAULT 'WORLD', b string DEFAULT 'PEOPLE') ENGINE = Memory;
...
DROP STREAM IF EXISTS test_null_as_default;
CREATE STREAM test_null_as_default (a int8, b int64 DEFAULT a + 1000) ENGINE = Memory;
...
DROP STREAM IF EXISTS test_null_as_default;
CREATE STREAM test_null_as_default (a int8, b int64 DEFAULT c - 500, c int32 DEFAULT a + 1000) ENGINE = Memory;

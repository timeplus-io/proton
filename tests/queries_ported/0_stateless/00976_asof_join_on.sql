...
CREATE STREAM A(a uint32, t uint32) ENGINE = Memory;
CREATE STREAM B(b uint32, t uint32) ENGINE = Memory;
...
-- proton: FIXME. SELECT count() FROM A ASOF JOIN B ON A.a == B.b AND A.t != B.t; -- { serverError 403 }

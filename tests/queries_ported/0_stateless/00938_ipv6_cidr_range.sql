...
SELECT IPv6CIDRToRange(to_fixed_string('1234', 10), 1); -- { serverError 43 }
SELECT IPv6CIDRToRange(to_fixed_string('1234', 16), to_uint16(1)); -- { serverError 43 }

SELECT 'tests';

DROP STREAM IF EXISTS ipv6_range;
create stream ipv6_range(ip IPv6, cidr uint8) ;

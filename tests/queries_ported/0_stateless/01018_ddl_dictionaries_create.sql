...
DROP DATABASE IF EXISTS memory_db CASCADE;
DROP DATABASE IF EXISTS db_01018 CASCADE;
DROP DATABASE IF EXISTS database_for_dict_01018 CASCADE;
...
SOURCE(TIMEPLUS(HOST 'localhost' PORT tcp_port() USER 'default' STREAM 'table_for_dict' PASSWORD '' DB 'database_for_dict_01018'))
...
DETACH DICTIONARY db_01018.dict1;  -- {serverError 48}
...
DROP DATABASE IF EXISTS lazy_db CASCADE;

...
SELECT to_start_of_ten_minutes(to_datetime('2017-12-31 00:00:00', 'UTC'), ''); -- {serverError 43}
SELECT to_start_of_ten_minutes(to_datetime('2017-12-31 05:12:30', 'UTC'), 'UTC'); -- success

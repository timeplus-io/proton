create stream tba (event_id int64, event_dt int64) Engine =MergeTree order by event_id ;
...
select count() from (
  ...
  ) as tba WHERE tba.event_dt >= 20220822 and tba.event_dt <= 20220822 and event_id = 403 );

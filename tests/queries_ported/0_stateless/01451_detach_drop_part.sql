...
SELECT name FROM system.detached_parts WHERE table = 'mt_01451' AND database = current_database();
...
SELECT name FROM system.parts WHERE table = 'mt_01451' AND active AND database = current_database();

...
$CLICKHOUSE_CLIENT -q "DROP STREAM IF EXISTS t_read_in_order_2";

$CLICKHOUSE_CLIENT -q "CREATE STREAM t_read_in_order_2(date Date, i uint64, v uint64) ENGINE = MergeTree ORDER BY (date, i)"

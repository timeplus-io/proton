...
SELECT COUNT(), part_type FROM system.parts WHERE database = current_database() AND table = 'merge_table_standard_delete' AND active GROUP BY part_type ORDER BY part_type;
...
SELECT COUNT(), part_type FROM system.parts WHERE database = current_database() AND table = 't_light' AND active GROUP BY part_type ORDER BY part_type;

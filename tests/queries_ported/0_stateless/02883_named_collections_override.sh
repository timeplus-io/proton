...
CREATE NAMED COLLECTION IF NOT EXISTS $u1 AS
    url = 'http://127.0.0.1:3218?query=select+1' NOT OVERRIDABLE,
    format = 'RawBLOB' OVERRIDABLE;

CREATE NAMED COLLECTION IF NOT EXISTS $u2 AS
    url = 'http://127.0.0.1:3218?query=select+1',
    format = 'RawBLOB';
...
-- SELECT * FROM url($u1, url='http://127.0.0.1:3218?query=select+2'); -- { serverError BAD_ARGUMENTS }
...
SELECT * FROM url($u2, url='http://127.0.0.1:3218?query=select+2');
...
-- SELECT * FROM url($u2, url='http://127.0.0.1:3218?query=select+2'); -- { serverError BAD_ARGUMENTS }
...
ALTER NAMED COLLECTION $u3 SET
    url = 'http://127.0.0.1:3218?query=select+2' OVERRIDABLE,
    format = 'RawBLOB' NOT OVERRIDABLE;

SELECT * FROM url($u3);
SELECT * FROM url($u3, url='http://127.0.0.1:3218?query=select+1');
...
-- SELECT * FROM url(url_override2, url='http://127.0.0.1:3218?query=select+2');
...
-- SELECT * FROM url(url_override1, url='http://127.0.0.1:3218?query=select+2'); -- { serverError BAD_ARGUMENTS }
-- SELECT * FROM url(url_override1, format='CSV');
...
-- SELECT * FROM url(url_override2, url='http://127.0.0.1:3218?query=select+2'); -- { serverError BAD_ARGUMENTS }

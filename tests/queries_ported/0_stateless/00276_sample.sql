...
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 0.1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/10;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/1e1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1e1/1e2;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1e-1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 2e-2;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/10 OFFSET 1/10;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/10 OFFSET 9/10;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/10 OFFSET 10/10;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/10 OFFSET 19/20;

SELECT count() >= 100 FROM sample_00276 SAMPLE 100;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1000;

SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 OFFSET 1/2;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 SETTINGS parallel_replicas_count = 3;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 0;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 2;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 OFFSET 1/2 SETTINGS parallel_replicas_count = 3;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 OFFSET 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 0;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 OFFSET 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 1;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 1/2 OFFSET 1/2 SETTINGS parallel_replicas_count = 3, parallel_replica_offset = 2;


SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM
(
...
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 0.05 OFFSET 0.35;
SELECT count(), min(x), max(x), sum(x), uniq_exact(x) FROM sample_00276 SAMPLE 0.05 OFFSET 0.4;

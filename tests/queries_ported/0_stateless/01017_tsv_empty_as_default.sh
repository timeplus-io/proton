...
$CLICKHOUSE_CLIENT --query="DROP STREAM IF EXISTS empty_as_default";
$CLICKHOUSE_CLIENT --query="CREATE STREAM empty_as_default (s string, n uint64 DEFAULT 1, d Date DEFAULT '2019-06-19') ENGINE = Memory";
...
$CLICKHOUSE_CLIENT --query="DROP STREAM empty_as_default";

...
select substring(materialize(cast('abcdefgh' as fixed_string(8))), -2, -2);
select substring(materialize(cast('abcdefgh' as fixed_string(8))), materialize(-2), materialize(-2));

select substring(cast('abcdefgh' as fixed_string(8)), -2, -1);
select substring(materialize(cast('abcdefgh' as fixed_string(8))), -2, -1);
select substring(materialize(cast('abcdefgh' as fixed_string(8))), materialize(-2), materialize(-1));

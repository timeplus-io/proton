...
$CLICKHOUSE_CLIENT -q "DROP STREAM IF EXISTS t_buffer_string"
$CLICKHOUSE_CLIENT -q "CREATE STREAM t_buffer_string(key string) ENGINE = Buffer('', '', 1, 1, 1, 1000000000000, 1000000000000, 1000000000000, 1000000000000)"
...
$CLICKHOUSE_CLIENT -q "DROP STREAM t_buffer_string"

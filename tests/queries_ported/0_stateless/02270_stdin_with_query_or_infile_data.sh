...
$CLICKHOUSE_CLIENT -q "DROP STREAM IF EXISTS test_02270"
$CLICKHOUSE_CLIENT -q "CREATE STREAM test_02270 (x uint32) ENGINE=Memory"
...
$CLICKHOUSE_CLIENT -q "DROP STREAM test_02270"

...
SELECT to_uint256(123) AS k FROM system.one INNER JOIN (SELECT to_uint256(123) AS k) t USING k;
...
SELECT to_int256(123) AS k FROM system.one INNER JOIN (SELECT to_int256(123) AS k) t USING k;
...
SELECT to_nullable(to_uint256(321)) AS k FROM system.one INNER JOIN (SELECT to_uint256(321) AS k) t USING k;
...
SELECT to_nullable(to_int256(321)) AS k FROM system.one INNER JOIN (SELECT to_int256(321) AS k) t USING k;

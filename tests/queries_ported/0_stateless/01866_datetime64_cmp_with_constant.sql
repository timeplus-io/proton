...
SELECT 'dt < const dt64' FROM dt64test WHERE dt_column < to_datetime64('2020-01-13 13:37:00', 3);
SELECT 'dt < dt64' FROM dt64test WHERE dt_column < materialize(to_datetime64('2020-01-13 13:37:00', 3));

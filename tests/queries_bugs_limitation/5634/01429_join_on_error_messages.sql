...
SELECT 1 FROM (select 1 as a)as A JOIN (select 1 as b) as B ON equals(a); -- { serverError 42 }
SELECT 1 FROM (select 1 as a)as A JOIN (select 1 as b) as B ON less(a); -- { serverError 42 }

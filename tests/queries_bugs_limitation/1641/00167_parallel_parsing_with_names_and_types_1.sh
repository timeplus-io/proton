...
FORMATS=('TSVWithNamesAndTypes' 'CSVWithNamesAndTypes')
...
do
    ...
    "SELECT URLRegions as d, to_timezone(ClientEventTime, 'Europe/Moscow') as a, MobilePhoneModel as b, ParamPrice as e, ClientIP6 as c FROM test.hits LIMIT 5000 Format $format" | \

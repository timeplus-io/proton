...
INSERT INTO test_table(id, value) VALUES (0, 'Value');
...
INSERT INTO test_table_join_1(id, value, value_join_1) VALUES (0, 'Join_1_Value', 'Join_1_Value');
...
INSERT INTO test_table_join_2(id, value, value_join_2) VALUES (0, 'Join_2_Value', 'Join_2_Value');
...
INSERT INTO test_table_join_3(id, value, value_join_3) VALUES (0, 'Join_3_Value', 'Join_3_Value');
...
DESCRIBE (SELECT arrayMap(x -> test_table.* EXCEPT value APPLY to_string, [1,2,3]) FROM test_table);

SELECT '--';

DESCRIBE (SELECT arrayMap(x -> test_table.* EXCEPT value APPLY x -> to_string(x), [1,2,3]) FROM test_table);
...
DESCRIBE (SELECT cast(tuple(1), 'Tuple (id uint64)') AS compound_value, arrayMap(x -> compound_value.* APPLY to_string, [1,2,3]));

SELECT '--';

DESCRIBE (SELECT cast(tuple(1), 'Tuple (id uint64)') AS compound_value, arrayMap(x -> compound_value.* APPLY x -> to_string(x), [1,2,3]));
...
DESCRIBE (SELECT cast(tuple(1, 'Value'), 'Tuple (id uint64, value string)') AS compound_value, arrayMap(x -> compound_value.* EXCEPT value APPLY to_string, [1,2,3]));

SELECT '--';

DESCRIBE (SELECT cast(tuple(1, 'Value'), 'Tuple (id uint64, value string)') AS compound_value, arrayMap(x -> compound_value.* EXCEPT value APPLY x -> to_string(x), [1,2,3]));

...
SELECT EXTRACT(DAY FROM to_date('2019-05-05') as arg_1), arg_1;
SELECT EXTRACT(DAY FROM to_date('2019-05-05') arg_1), arg_1;
...
SELECT dateAdd(DAY, 1 AS arg_1, to_date('2019-05-05') AS arg_2), arg_1, arg_2;
SELECT dateAdd(DAY, 1 arg_1, to_date('2019-05-05') arg_2), arg_1, arg_2;
...
SELECT dateSub(DAY, 1 AS arg_1, to_date('2019-05-05') AS arg_2), arg_1, arg_2;
SELECT dateSub(DAY, 1 arg_1, to_date('2019-05-05') arg_2), arg_1, arg_2;
...
SELECT dateDiff(DAY, to_date('2019-05-05') AS arg_1, to_date('2019-05-06') AS arg_2), arg_1, arg_2;
SELECT dateDiff(DAY, to_date('2019-05-05') arg_1, to_date('2019-05-06') arg_2), arg_1, arg_2;
SELECT dateDiff(DAY, to_date('2019-05-05') AS arg_1, to_date('2019-05-06') AS arg_2, 'UTC'), arg_1, arg_2;
SELECT dateDiff(DAY, to_date('2019-05-05') arg_1, to_date('2019-05-06') arg_2, 'UTC'), arg_1, arg_2;

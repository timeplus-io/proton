select toDate32('1990-02-01') = to_date('1990-02-01');
select to_date('1991-01-02') > toDate32('1990-02-01');
select toDate32('1925-02-01') <= to_date('1990-02-01');
select to_date('1991-02-01') < toDate32('2283-11-11');
select toDate32('1990-02-01') = to_datetime('1990-02-01');
select to_datetime('1991-01-02') > toDate32('1990-02-01');
select toDate32('1925-02-01') <= to_datetime('1990-02-01');
select to_datetime('1991-02-01') < toDate32('2283-11-11');

...
$CLICKHOUSE_CLIENT --query="create stream msgpack (array1 array(array(uint32)), array2 array(array(array(string)))) ";
...
$CLICKHOUSE_CLIENT --query="create stream msgpack (array array(uint8)) ";
...
$CLICKHOUSE_CLIENT --query="create stream msgpack (array array(int64)) ";

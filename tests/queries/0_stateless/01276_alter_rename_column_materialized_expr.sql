...
INSERT INTO table_for_rename (date, key, value1, value2) SELECT to_date('2019-10-01') + number % 3, number, to_string(number), to_string(number + 1) from numbers(9);
...
INSERT INTO table_for_rename (date, key, value4, value5) SELECT to_date('2019-10-01') + number % 3, number, to_string(number), to_string(number + 1) from numbers(10, 10);
SELECT * FROM table_for_rename ORDER BY key;
...
INSERT INTO table_for_rename (date, key, value1, value2) SELECT to_date('2019-10-01') + number % 3, number, to_string(number), to_string(number + 1) from numbers(20,10);
SELECT * FROM table_for_rename ORDER BY key;

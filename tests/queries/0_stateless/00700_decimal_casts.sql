...
SELECT to_float64(999999999999999999)   as x, toDecimal128(x, 0), toDecimal128(-x, 0);
SELECT to_float64(99999999999999999.9)  as x, toDecimal128(x, 1), toDecimal128(-x, 1);
SELECT to_float64(9999999999999999.99)  as x, toDecimal128(x, 2), toDecimal128(-x, 2);
SELECT to_float64(999999999999999.999)  as x, toDecimal128(x, 3), toDecimal128(-x, 3);
SELECT to_float64(99999999999999.9999)  as x, toDecimal128(x, 4), toDecimal128(-x, 4);
SELECT to_float64(9999999999999.99999)  as x, toDecimal128(x, 5), toDecimal128(-x, 5);
SELECT to_float64(999999999999.999999)  as x, toDecimal128(x, 6), toDecimal128(-x, 6);
SELECT to_float64(99999999999.9999999)  as x, toDecimal128(x, 7), toDecimal128(-x, 7);
SELECT to_float64(9999999999.99999999)  as x, toDecimal128(x, 8), toDecimal128(-x, 8);
SELECT to_float64(999999999.999999999)  as x, toDecimal128(x, 9), toDecimal128(-x, 9);
SELECT to_float64(999999999.999999999)  as x, toDecimal128(x, 9), toDecimal128(-x, 9);
SELECT to_float64(99999999.9999999999)  as x, toDecimal128(x, 10), toDecimal128(-x, 10);
SELECT to_float64(9999999.99999999999)  as x, toDecimal128(x, 11), toDecimal128(-x, 11);
SELECT to_float64(999999.999999999999)  as x, toDecimal128(x, 12), toDecimal128(-x, 12);
SELECT to_float64(99999.9999999999999)  as x, toDecimal128(x, 13), toDecimal128(-x, 13);
SELECT to_float64(9999.99999999999999)  as x, toDecimal128(x, 14), toDecimal128(-x, 14);
SELECT to_float64(999.999999999999999)  as x, toDecimal128(x, 15), toDecimal128(-x, 15);
SELECT to_float64(99.9999999999999999)  as x, toDecimal128(x, 16), toDecimal128(-x, 16);
SELECT to_float64(9.99999999999999999)  as x, toDecimal128(x, 17), toDecimal128(-x, 17);
SELECT to_float64(0.999999999999999999) as x, toDecimal128(x, 18), toDecimal128(-x, 18);

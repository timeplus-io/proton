...
SELECT toFloat64(999999999)   as x, to_decimal32(x, 0), to_decimal32(-x, 0), to_decimal64(x, 0), to_decimal64(-x, 0);
SELECT toFloat64(99999999.9)  as x, to_decimal32(x, 1), to_decimal32(-x, 1), to_decimal64(x, 1), to_decimal64(-x, 1);
SELECT toFloat64(9999999.99)  as x, to_decimal32(x, 2), to_decimal32(-x, 2), to_decimal64(x, 2), to_decimal64(-x, 2);
SELECT toFloat64(999999.999)  as x, to_decimal32(x, 3), to_decimal32(-x, 3), to_decimal64(x, 3), to_decimal64(-x, 3);
SELECT toFloat64(99999.9999)  as x, to_decimal32(x, 4), to_decimal32(-x, 4), to_decimal64(x, 4), to_decimal64(-x, 4);
SELECT toFloat64(9999.99999)  as x, to_decimal32(x, 5), to_decimal32(-x, 5), to_decimal64(x, 5), to_decimal64(-x, 5);
SELECT toFloat64(999.999999)  as x, to_decimal32(x, 6), to_decimal32(-x, 6), to_decimal64(x, 6), to_decimal64(-x, 6);
SELECT toFloat64(99.9999999)  as x, to_decimal32(x, 7), to_decimal32(-x, 7), to_decimal64(x, 7), to_decimal64(-x, 7);
SELECT toFloat64(9.99999999)  as x, to_decimal32(x, 8), to_decimal32(-x, 8), to_decimal64(x, 8), to_decimal64(-x, 8);
SELECT toFloat64(0.999999999) as x, to_decimal32(x, 9), to_decimal32(-x, 9), to_decimal64(x, 9), to_decimal64(-x, 9);

SELECT toFloat64(999999999.999999999)  as x, to_decimal64(x, 9), to_decimal64(-x, 9);
SELECT toFloat64(99999999.9999999999)  as x, to_decimal64(x, 10), to_decimal64(-x, 10);
SELECT toFloat64(9999999.99999999999)  as x, to_decimal64(x, 11), to_decimal64(-x, 11);
SELECT toFloat64(999999.999999999999)  as x, to_decimal64(x, 12), to_decimal64(-x, 12);
SELECT toFloat64(99999.9999999999999)  as x, to_decimal64(x, 13), to_decimal64(-x, 13);
SELECT toFloat64(9999.99999999999999)  as x, to_decimal64(x, 14), to_decimal64(-x, 14);
SELECT toFloat64(999.999999999999999)  as x, to_decimal64(x, 15), to_decimal64(-x, 15);
SELECT toFloat64(99.9999999999999999)  as x, to_decimal64(x, 16), to_decimal64(-x, 16);
SELECT toFloat64(9.99999999999999999)  as x, to_decimal64(x, 17), to_decimal64(-x, 17);
SELECT toFloat64(0.999999999999999999) as x, to_decimal64(x, 18), to_decimal64(-x, 18);
...
SELECT to_int32(999999999) as x, to_decimal64(x, 9), to_decimal64(-x, 9), toDecimal128(x, 29), toDecimal128(-x, 29);
SELECT to_int64(999999999) as x, to_decimal64(x, 9), to_decimal64(-x, 9), toDecimal128(x, 29), toDecimal128(-x, 29);
SELECT to_int64(999999999999999999) as x, to_decimal64(x, 0), to_decimal64(-x, 0);
SELECT to_int64(999999999999999999) as x, toDecimal128(x, 0), toDecimal128(-x, 0);
SELECT to_int64(999999999999999999) as x, toDecimal128(x, 20), toDecimal128(-x, 20);

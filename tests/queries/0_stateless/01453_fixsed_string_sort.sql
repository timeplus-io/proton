...
drop stream if exists badFixedStringSort;
create stream IF NOT EXISTS badFixedStringSort (uuid5_old FixedString(16), subitem string) engine=MergeTree order by  tuple();

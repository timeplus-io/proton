...
SELECT arrayFill(x -> not is_null(x), [1, null, 3, 11, 12, null, null, 5, 6, 14, null, null]);
SELECT arrayReverseFill(x -> not is_null(x), [1, null, 3, 11, 12, null, null, 5, 6, 14, null, null]);

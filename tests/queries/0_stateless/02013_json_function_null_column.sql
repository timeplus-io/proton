...
SELECT JSONExtract(toNullable('{"string_value":null}'), 'string_value', 'Nullable(string)') as x, to_type_name(x);
SELECT JSONExtract(toNullable('{"string_value":null}'), 'string_value', 'string') as x, to_type_name(x);

...
select DATE_DIFF(MONTH, to_date('2018-12-18'), to_date('2018-01-01'));
select DATE_DIFF(QQ, to_date('2018-12-18'), to_date('2018-01-01'));
select DATE_ADD(YEAR, 3, to_date('2018-01-01'));
select timestamp_sub(SQL_TSI_MONTH, 5, to_datetime('2018-12-18 01:02:03'));
select timestamp_ADD(to_date('2018-01-01'), INTERVAL 3 MONTH);

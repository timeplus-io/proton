...
$CLICKHOUSE_CLIENT -q "create stream $db.\`таблица_со_странным_названием\` (a uint64, b uint64)  ;"
...
$CLICKHOUSE_CLIENT -q "create stream $lazy_db.\`таблица_со_странным_названием\` (a uint64, b uint64)  ;"
...
$CLICKHOUSE_CLIENT -q "create stream IF NOT EXISTS $lazy_db.test (a uint64, b uint64)  ;"
$CLICKHOUSE_CLIENT -q "create stream IF NOT EXISTS $lazy_db.test (a uint64, b uint64)  ;"

...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_1"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_1 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_2"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_2 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_3"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_3 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_4"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_4 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_5"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_5 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM IF EXISTS input_function_table_6"
${CLICKHOUSE_CLIENT} --query="create stream input_function_table_6 (a string, b date, c int32, d Int16) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_1"
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_2"
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_3"
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_4"
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_5"
${CLICKHOUSE_CLIENT} --query="DROP STREAM input_function_table_6"

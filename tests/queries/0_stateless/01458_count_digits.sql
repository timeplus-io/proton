...
SELECT countDigits(toNullable(to_decimal32(4.2, 1))), countDigits(materialize(toNullable(to_decimal32(4.2, 2)))),
       countDigits(toNullable(to_decimal64(4.2, 3))), countDigits(materialize(toNullable(to_decimal64(4.2, 4)))),

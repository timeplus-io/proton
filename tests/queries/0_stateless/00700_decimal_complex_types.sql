...
SELECT indexOf(a, to_decimal32(0.1, 3)), indexOf(a, to_decimal32(1.0, 3)) FROM decimal;
SELECT indexOf(b, to_decimal64(0.5, 3)), indexOf(b, to_decimal64(1.0, 3)) FROM decimal;
SELECT indexOf(c, toDecimal128(0.9, 3)), indexOf(c, toDecimal128(1.0, 3)) FROM decimal;

SELECT indexOf(a, to_decimal32(0.1, 2)) FROM decimal;
SELECT indexOf(a, to_decimal32(0.1, 4)) FROM decimal;
SELECT indexOf(a, to_decimal64(0.1, 3)) FROM decimal;
SELECT indexOf(a, toDecimal128(0.1, 3)) FROM decimal;
SELECT indexOf(b, to_decimal32(0.4, 3)) FROM decimal;
SELECT indexOf(b, to_decimal64(0.4, 2)) FROM decimal;
SELECT indexOf(b, to_decimal64(0.4, 4)) FROM decimal;
SELECT indexOf(b, toDecimal128(0.4, 3)) FROM decimal;
SELECT indexOf(c, to_decimal32(0.7, 3)) FROM decimal;
SELECT indexOf(c, to_decimal64(0.7, 3)) FROM decimal;
...
SELECT to_decimal32(12345.6789, 4) AS x, countEqual([x+1, x, x], x), countEqual([x, x-1, x], x), countEqual([x, x], x-0);
SELECT to_decimal32(-12345.6789, 4) AS x, countEqual([x+1, x, x], x), countEqual([x, x-1, x], x), countEqual([x, x], x+0);
SELECT to_decimal64(123456789.123456789, 9) AS x, countEqual([x+1, x, x], x), countEqual([x, x-1, x], x), countEqual([x, x], x-0);
SELECT to_decimal64(-123456789.123456789, 9) AS x, countEqual([x+1, x, x], x), countEqual([x, x-1, x], x), countEqual([x, x], x+0);

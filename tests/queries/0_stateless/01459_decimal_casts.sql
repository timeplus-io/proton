...
SELECT to_float64(number) y, to_decimal32(y, 1), to_decimal64(y, 5), toDecimal128(y, 6), toDecimal256(y, 7) FROM numbers(8, 1);
...
SELECT to_float64(to_decimal32(number, 1)), to_float64(to_decimal64(number, 2)), to_float64(toDecimal128(number, 3)) FROM numbers(13, 1);

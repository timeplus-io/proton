...
${CLICKHOUSE_CLIENT} --query="create stream arrow_dicts (a LowCardinality(string), b array(LowCardinality(string)), c tuple(LowCardinality(string), LowCardinality(string))) ENGINE=Memory()"
...
${CLICKHOUSE_CLIENT} --query="create stream arrow_dicts (a LowCardinality(string)) ENGINE=Memory()"

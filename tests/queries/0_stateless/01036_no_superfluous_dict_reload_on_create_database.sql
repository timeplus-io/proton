...
create stream dict_db_01036.dict_data (key uint64, val uint64) Engine=Memory();
...
SELECT dictGetUInt64('dict_db_01036.dict', 'val', to_uint64(0));
SELECT query_count FROM system.dictionaries WHERE database = 'dict_db_01036' AND name = 'dict';
...
DROP STREAM dict_db_01036.dict_data;

...
SELECT toDecimal128('9223372036854775807', 6) AS x, to_int64(x), to_int64(-x);
SELECT toDecimal128('9223372036854775809', 6) AS x, to_int64(x); -- { serverError 407 }
SELECT toDecimal128('9223372036854775809', 6) AS x, to_int64(-x); -- { serverError 407 }
...
SELECT toDecimal128('2147483647', 10) AS x, to_int32(x), to_int32(-x);
SELECT toDecimal128('2147483649', 10) AS x, to_int32(x), to_int32(-x); -- { serverError 407 }
...
SELECT toDecimal128('92233720368547757.99', 2) AS x, to_int64(x), to_int64(-x);
SELECT to_decimal64('2147483640.99', 2) AS x, to_int32(x), to_int32(-x);

SELECT toDecimal128('-0.9', 8) AS x, to_uint64(x);
SELECT to_decimal64('-0.9', 8) AS x, to_uint64(x);
SELECT to_decimal32('-0.9', 8) AS x, to_uint64(x);

SELECT toDecimal128('-0.8', 4) AS x, to_uint32(x);
SELECT to_decimal64('-0.8', 4) AS x, to_uint32(x);
SELECT to_decimal32('-0.8', 4) AS x, to_uint32(x);

SELECT toDecimal128('-0.7', 2) AS x, to_uint16(x);
SELECT to_decimal64('-0.7', 2) AS x, to_uint16(x);
SELECT to_decimal32('-0.7', 2) AS x, to_uint16(x);

SELECT toDecimal128('-0.6', 6) AS x, to_uint8(x);
SELECT to_decimal64('-0.6', 6) AS x, to_uint8(x);
SELECT to_decimal32('-0.6', 6) AS x, to_uint8(x);

SELECT toDecimal128('-1', 7) AS x, to_uint64(x); -- { serverError 407 }
SELECT toDecimal128('-1', 7) AS x, to_uint32(x); -- { serverError 407 }
SELECT toDecimal128('-1', 7) AS x, to_uint16(x); -- { serverError 407 }
SELECT toDecimal128('-1', 7) AS x, to_uint8(x); -- { serverError 407 }
...
SELECT toDecimal128('18446744073709551615', 0) AS x, to_uint64(x);
SELECT toDecimal128('18446744073709551616', 0) AS x, to_uint64(x); -- { serverError 407 }
SELECT toDecimal128('18446744073709551615', 8) AS x, to_uint64(x);
SELECT toDecimal128('18446744073709551616', 8) AS x, to_uint64(x); -- { serverError 407 }

SELECT toDecimal128('4294967295', 0) AS x, to_uint32(x);
SELECT toDecimal128('4294967296', 0) AS x, to_uint32(x); -- { serverError 407 }
SELECT toDecimal128('4294967295', 10) AS x, to_uint32(x);
SELECT toDecimal128('4294967296', 10) AS x, to_uint32(x); -- { serverError 407 }
...
SELECT toDecimal128('65535', 0) AS x, to_uint16(x);
SELECT toDecimal128('65536', 0) AS x, to_uint16(x); -- { serverError 407 }
SELECT toDecimal128('65535', 10) AS x, to_uint16(x);
SELECT toDecimal128('65536', 10) AS x, to_uint16(x); -- { serverError 407 }
...
SELECT to_decimal32(0, rowNumberInBlock()); -- { serverError 44 }
SELECT to_decimal64(0, rowNumberInBlock()); -- { serverError 44 }

...
drop stream if exists db_01721.table_decimal_dict;
drop dictionary if exists db_01721.decimal_dict;


create database db_01721;

create stream db_01721.table_decimal_dict(
KeyField uint64,
...
SELECT dictGet('db_01721.decimal_dict', 'Decimal32_', to_uint64(42)),
       dictGet('db_01721.decimal_dict', 'Decimal64_', to_uint64(42)),
       dictGet('db_01721.decimal_dict', 'Decimal128_', to_uint64(42))
       -- ,dictGet('db_01721.decimal_dict', 'Decimal256_', to_uint64(42))
;
...
SELECT dictGet('db_01721.decimal_dict', 'Decimal32_', to_uint64(4999)),
       dictGet('db_01721.decimal_dict', 'Decimal64_', to_uint64(4999)),
       dictGet('db_01721.decimal_dict', 'Decimal128_', to_uint64(4999))
       --,dictGet('db_01721.decimal_dict', 'Decimal256_', to_uint64(4999))
;
...
SELECT dictGet('db_01721.decimal_dict', 'Decimal32_', to_uint64(5000)),
       dictGet('db_01721.decimal_dict', 'Decimal64_', to_uint64(5000)),
       dictGet('db_01721.decimal_dict', 'Decimal128_', to_uint64(5000))
       --,dictGet('db_01721.decimal_dict', 'Decimal256_', to_uint64(5000))
;

drop stream if exists table_decimal_dict;

...
DROP STREAM IF EXISTS 01760_db.example_simple_key_source;
create stream 01760_db.example_simple_key_source (id uint64, value uint64) ;
...
DROP STREAM 01760_db.example_simple_key_source;
DROP DICTIONARY 01760_db.example_simple_key_dictionary;

SELECT name, database, key.names, key.types, attribute.names, attribute.types, status FROM system.dictionaries WHERE database='01760_db';

DROP STREAM IF EXISTS 01760_db.example_complex_key_source;
create stream 01760_db.example_complex_key_source (id uint64, id_key string, value uint64) ;
...
DROP STREAM 01760_db.example_complex_key_source;

select 'const args';
select 'concat';
select arrayConcat(empty_array_uint8());
select arrayConcat(empty_array_uint8(), empty_array_uint8());
select arrayConcat(empty_array_uint8(), empty_array_uint8(), empty_array_uint8());
select arrayConcat([Null], empty_array_uint8());
select arrayConcat([Null], empty_array_uint8(), [1]);
...
select arrayPushBack(empty_array_uint8(), 1);
select arrayPushBack(empty_array_uint8(), -1);
...
select arrayPushFront(empty_array_uint8(), 1);
select arrayPushFront(empty_array_uint8(), -1);

select 'pop back';
select arrayPopBack(Null);
select arrayPopBack(empty_array_uint8());
...
select arrayPopFront(empty_array_uint8());
...
select '';
select 'table';
create stream array_functions (arr1 array(int8), arr2 array(int8), o int8, no Nullable(int8), l int8, nl Nullable(int8)) engine = TinyLog;
...
select '';
select 'table';
create stream array_functions (arr1 array(Nullable(int8)), arr2 array(Nullable(Float32)), o int8, no Nullable(int8), l int8, nl Nullable(int8)) engine = TinyLog;
...
select '';
select 'table';
create stream array_functions (arr1 array(Nullable(int8)), arr2 array(uint8), o int8, no Nullable(int8), l int8, nl Nullable(int8)) engine = TinyLog;
...
select '';
select 'table';
create stream array_functions (arr1 array(Nullable(string)), arr2 array(string), val string, val2 Nullable(string), o int8, no Nullable(int8), l int8, nl Nullable(int8)) engine = TinyLog;

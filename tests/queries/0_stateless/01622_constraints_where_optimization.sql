...
create stream t_constraints_where(a uint32, b uint32, CONSTRAINT c1 ASSUME b >= 5, CONSTRAINT c2 ASSUME b <= 10) ;
...
create stream t_constraints_where(a uint32, b uint32, CONSTRAINT c1 ASSUME b < 10) ;

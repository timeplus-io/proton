...
create stream 01681_database_for_flat_dictionary.simple_key_simple_attributes_source_table
(
   id uint64,
   value_first string,
   value_second string
...
SELECT dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_simple_attributes', 'value_first', number, to_string('default')) as value_first,
    dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_simple_attributes', 'value_second', number, to_string('default')) as value_second FROM system.numbers LIMIT 3;
SELECT 'dictGetOrDefault non existing value';
SELECT dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_simple_attributes', 'value_first', number, to_string('default')) as value_first,
    dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_simple_attributes', 'value_second', number, to_string('default')) as value_second FROM system.numbers LIMIT 4;
SELECT 'dictHas';
...
DROP STREAM 01681_database_for_flat_dictionary.simple_key_simple_attributes_source_table;

create stream 01681_database_for_flat_dictionary.simple_key_complex_attributes_source_table
(
   id uint64,
   value_first string,
...
SELECT 'dictGetOrDefault existing value';
SELECT dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_complex_attributes', 'value_first', number, to_string('default')) as value_first,
    dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_complex_attributes', 'value_second', number, to_string('default')) as value_second FROM system.numbers LIMIT 3;
SELECT 'dictGetOrDefault non existing value';
SELECT dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_complex_attributes', 'value_first', number, to_string('default')) as value_first,
    dictGetOrDefault('01681_database_for_flat_dictionary.flat_dictionary_simple_key_complex_attributes', 'value_second', number, to_string('default')) as value_second FROM system.numbers LIMIT 4;
SELECT 'dictHas';
...
DROP STREAM 01681_database_for_flat_dictionary.simple_key_complex_attributes_source_table;

create stream 01681_database_for_flat_dictionary.simple_key_hierarchy_table
(
    id uint64,
    parent_id uint64
) ();
...
SELECT dictGetHierarchy('01681_database_for_flat_dictionary.flat_dictionary_simple_key_hierarchy', to_uint64(1));
SELECT dictGetHierarchy('01681_database_for_flat_dictionary.flat_dictionary_simple_key_hierarchy', to_uint64(4));

DROP DICTIONARY 01681_database_for_flat_dictionary.flat_dictionary_simple_key_hierarchy;
DROP STREAM 01681_database_for_flat_dictionary.simple_key_hierarchy_table;

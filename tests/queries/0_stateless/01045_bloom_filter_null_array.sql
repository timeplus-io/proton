...
create stream bloom_filter_null_array (v array(LowCardinality(Nullable(string))), INDEX idx v TYPE bloom_filter(0.1) GRANULARITY 1) ENGINE = MergeTree() ORDER BY v SETTINGS allow_nullable_key = 1;

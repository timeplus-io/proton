...
WITH CAST('text' as LowCardinality(string)) as input, 'aes-256-ofb' as mode SELECT to_type_name(input), hex(aes_encrypt_mysql(mode, input, key32, iv)) FROM encryption_test LIMIT 1;

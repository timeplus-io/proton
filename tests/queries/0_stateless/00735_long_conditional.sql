...
SELECT to_int8(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int8(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int16(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int16(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int32(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int32(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_int64(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT to_int64(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint8(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint8(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint16(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint16(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint32(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint32(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_uint64(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT to_uint64(0) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT to_date(0) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 43 }
...
SELECT to_date(0) AS x, toDecimal128(1, 0) AS y, ((x = 0) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 43 }
...
SELECT to_datetime(0, 'Europe/Moscow') AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT to_datetime(0, 'Europe/Moscow') AS x, toDecimal128(1, 0) AS y, ((x = 0) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT materialize(to_int8(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int8(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int16(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int16(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int32(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int32(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_int64(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT materialize(to_int64(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint8(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint8(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint16(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint16(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint32(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint32(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_uint64(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT materialize(to_uint64(0)) AS x, toDecimal128(1, 0) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z);
...
SELECT materialize(to_date(0)) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 43 }
...
SELECT materialize(to_date(0)) AS x, toDecimal128(1, 0) AS y, ((x = 0) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 43 }
...
SELECT materialize(to_datetime(0, 'Europe/Moscow')) AS x, toFloat64(1) AS y, ((x > y) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }
...
SELECT materialize(to_datetime(0, 'Europe/Moscow')) AS x, toDecimal128(1, 0) AS y, ((x = 0) ? x : y) AS z, to_type_name(x), to_type_name(y), to_type_name(z); -- { serverError 386 }

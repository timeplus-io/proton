...
SELECT DISTINCT substring(to_string(range(rand(1) % 50)), rand(2) % 50, rand(3) % 50) = substringUTF8(to_string(range(rand(1) % 50)), rand(2) % 50, rand(3) % 50) AS res FROM numbers(1000000);
SELECT DISTINCT substring(to_string(range(rand(1) % 50)), rand(2) % 50) = substringUTF8(to_string(range(rand(1) % 50)), rand(2) % 50) AS res FROM numbers(1000000);

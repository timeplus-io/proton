...
create stream test_01383.fact (id1 int64, id2 int64, value int64) ENGINE = MergeTree() ORDER BY id1;
create stream test_01383.dimension (id1 int64, name string) ENGINE = MergeTree() ORDER BY id1;

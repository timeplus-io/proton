...
SELECT getSetting('custom_a') as v, to_type_name(v);
SELECT getSetting('custom_b') as v, to_type_name(v);
SELECT getSetting('custom_c') as v, to_type_name(v);
SELECT getSetting('custom_d') as v, to_type_name(v);
...
SELECT '';
SELECT getSetting('custom_e') as v, to_type_name(v); -- { serverError 115 } -- Setting not found.
SET custom_e = 404;
SELECT getSetting('custom_e') as v, to_type_name(v);
...
SELECT '';
SELECT getSetting('custom_e') as v, to_type_name(v) SETTINGS custom_e = -0.333;
...
SELECT getSetting('custom_compound.identifier.v1') as v, to_type_name(v);

...
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_datetime('2015-08-18 00:00:00', 'UTC'));
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_datetime('2015-08-18 00:00:10', 'UTC'));
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_datetime('2015-08-18 00:10:00', 'UTC'));
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_datetime('2015-08-18 01:00:00', 'UTC'));
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_datetime('2015-08-18 01:10:10', 'UTC'));

-- DateTime vs DateTime64
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), toDateTime64('2015-08-18 00:00:00', 3, 'UTC'));
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), toDateTime64('2015-08-18 00:00:10', 3, 'UTC'));
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), toDateTime64('2015-08-18 00:10:00', 3, 'UTC'));
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), toDateTime64('2015-08-18 01:00:00', 3, 'UTC'));
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), toDateTime64('2015-08-18 01:10:10', 3, 'UTC'));

-- With date
-- DateTime64 vs date
SELECT dateDiff('day', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), to_date('2015-08-19', 'UTC'));

-- date vs DateTime64
SELECT dateDiff('day', to_date('2015-08-18', 'UTC'), toDateTime64('2015-08-19 00:00:00', 3, 'UTC'));
...
SELECT dateDiff('second', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), materialize(to_datetime('2015-08-18 00:00:10', 'UTC')));
SELECT dateDiff('second', to_datetime('2015-08-18 00:00:00', 'UTC'), materialize(toDateTime64('2015-08-18 00:00:10', 3, 'UTC')));
SELECT dateDiff('day', toDateTime64('2015-08-18 00:00:00', 0, 'UTC'), materialize(to_date('2015-08-19', 'UTC')));
SELECT dateDiff('day', to_date('2015-08-18', 'UTC'), materialize(toDateTime64('2015-08-19 00:00:00', 3, 'UTC')));
...
SELECT dateDiff('second', materialize(toDateTime64('2015-08-18 00:00:00', 0, 'UTC')), to_datetime('2015-08-18 00:00:10', 'UTC'));
SELECT dateDiff('second', materialize(to_datetime('2015-08-18 00:00:00', 'UTC')), toDateTime64('2015-08-18 00:00:10', 3, 'UTC'));
SELECT dateDiff('day', materialize(toDateTime64('2015-08-18 00:00:00', 0, 'UTC')), to_date('2015-08-19', 'UTC'));
SELECT dateDiff('day', materialize(to_date('2015-08-18', 'UTC')), toDateTime64('2015-08-19 00:00:00', 3, 'UTC'));
...
SELECT dateDiff('second', materialize(toDateTime64('2015-08-18 00:00:00', 0, 'UTC')), materialize(to_datetime('2015-08-18 00:00:10', 'UTC')));
SELECT dateDiff('second', materialize(to_datetime('2015-08-18 00:00:00', 'UTC')), materialize(toDateTime64('2015-08-18 00:00:10', 3, 'UTC')));
SELECT dateDiff('day', materialize(toDateTime64('2015-08-18 00:00:00', 0, 'UTC')), materialize(to_date('2015-08-19', 'UTC')));
SELECT dateDiff('day', materialize(to_date('2015-08-18', 'UTC')), materialize(toDateTime64('2015-08-19 00:00:00', 3, 'UTC')));

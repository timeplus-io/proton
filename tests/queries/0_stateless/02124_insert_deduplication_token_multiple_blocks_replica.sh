...
$CLICKHOUSE_CLIENT --query="DROP STREAM IF EXISTS block_dedup_token_replica SYNC"
$CLICKHOUSE_CLIENT --query="create stream block_dedup_token_replica (id int32) ENGINE=ReplicatedMergeTree('/$CLICKHOUSE_TEST_ZOOKEEPER_PREFIX/{table}', '{replica}') ORDER BY id"
...
$CLICKHOUSE_CLIENT --query="DROP STREAM block_dedup_token_replica SYNC"

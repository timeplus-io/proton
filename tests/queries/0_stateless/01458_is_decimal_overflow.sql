SELECT isDecimalOverflow(to_decimal32(0, 0), 0),
       ...
       isDecimalOverflow(to_decimal128(0, 0), 0);
...
SELECT isDecimalOverflow(to_decimal128('99999999999999999999999999999999999999', 0) + 1, 38),
       isDecimalOverflow(to_decimal128('99999999999999999999999999999999999999', 0) + 1),
       isDecimalOverflow(to_decimal128('-99999999999999999999999999999999999999', 0) - 1, 38),
       isDecimalOverflow(to_decimal128('-99999999999999999999999999999999999999', 0) - 1);
SELECT isDecimalOverflow(to_decimal128('99999999999999999999999999999999999999', 0), 38),
       isDecimalOverflow(to_decimal128('99999999999999999999999999999999999999', 0)),
       isDecimalOverflow(to_decimal128('-99999999999999999999999999999999999999', 0), 38),
       isDecimalOverflow(to_decimal128('-99999999999999999999999999999999999999', 0));
SELECT isDecimalOverflow(to_decimal128('99999999999999999999999999999999999999', 0), 37),
       isDecimalOverflow(to_decimal128('10', 0), 1),
       isDecimalOverflow(to_decimal128('1', 0), 0),
       isDecimalOverflow(to_decimal128('-99999999999999999999999999999999999999', 0), 37),
       isDecimalOverflow(to_decimal128('-10', 0), 1),
       isDecimalOverflow(to_decimal128('-1', 0), 0);

SELECT isDecimalOverflow(materialize(to_decimal128('99999999999999999999999999999999999999', 0)) + 1, 38),
       isDecimalOverflow(materialize(to_decimal128('99999999999999999999999999999999999999', 0)) + 1),
       isDecimalOverflow(materialize(to_decimal128('-99999999999999999999999999999999999999', 0)) - 1, 38),
       isDecimalOverflow(materialize(to_decimal128('-99999999999999999999999999999999999999', 0)) - 1);
SELECT isDecimalOverflow(materialize(to_decimal128('99999999999999999999999999999999999999', 0)), 38),
       isDecimalOverflow(materialize(to_decimal128('99999999999999999999999999999999999999', 0))),
       isDecimalOverflow(materialize(to_decimal128('-99999999999999999999999999999999999999', 0)), 38),
       isDecimalOverflow(materialize(to_decimal128('-99999999999999999999999999999999999999', 0)));
SELECT isDecimalOverflow(materialize(to_decimal128('99999999999999999999999999999999999999', 0)), 37),
       isDecimalOverflow(materialize(to_decimal128('10', 0)), 1),
       isDecimalOverflow(materialize(to_decimal128('1', 0)), 0),
       isDecimalOverflow(materialize(to_decimal128('-99999999999999999999999999999999999999', 0)), 37),
       isDecimalOverflow(materialize(to_decimal128('-10', 0)), 1),
       isDecimalOverflow(materialize(to_decimal128('-1', 0)), 0);
...
SELECT isDecimalOverflow(to_nullable(to_decimal32(42, 0)), 1),
       ...
       isDecimalOverflow(to_nullable(to_decimal128(42, 0)), 1),
       isDecimalOverflow(materialize(to_nullable(to_decimal128(42, 0))), 2);

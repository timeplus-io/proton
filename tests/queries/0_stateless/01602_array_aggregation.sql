...
SELECT to_type_name(arrayMin([to_float32(0)])), to_type_name(arrayMin([toFloat64(0)]));
SELECT to_type_name(arrayMin([to_decimal32(0, 8)])), to_type_name(arrayMin([to_decimal64(0, 8)])), to_type_name(arrayMin([toDecimal128(0, 8)]));
...
SELECT to_type_name(arrayMax([to_float32(0)])), to_type_name(arrayMax([toFloat64(0)]));
SELECT to_type_name(arrayMax([to_decimal32(0, 8)])), to_type_name(arrayMax([to_decimal64(0, 8)])), to_type_name(arrayMax([toDecimal128(0, 8)]));
...
SELECT to_type_name(arraySum([to_int128(0)])), to_type_name(arraySum([toInt256(0)])), to_type_name(arraySum([toUInt256(0)]));
SELECT to_type_name(arraySum([to_float32(0)])), to_type_name(arraySum([toFloat64(0)]));
SELECT to_type_name(arraySum([to_decimal32(0, 8)])), to_type_name(arraySum([to_decimal64(0, 8)])), to_type_name(arraySum([toDecimal128(0, 8)]));
...
SELECT to_type_name(arrayAvg([to_float32(0)])), to_type_name(arrayAvg([toFloat64(0)]));
SELECT to_type_name(arrayAvg([to_decimal32(0, 8)])), to_type_name(arrayAvg([to_decimal64(0, 8)])), to_type_name(arrayAvg([toDecimal128(0, 8)]));

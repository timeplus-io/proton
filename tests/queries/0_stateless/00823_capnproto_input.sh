...
$CLICKHOUSE_CLIENT -q "DROP STREAM IF EXISTS capnproto_input"
$CLICKHOUSE_CLIENT -q "create stream capnproto_input
(
    number uint64,
    string string,
...
$CLICKHOUSE_CLIENT -q "DROP STREAM capnproto_input"

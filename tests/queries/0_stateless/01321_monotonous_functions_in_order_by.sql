...
SELECT number FROM numbers(3) ORDER BY to_float32(toFloat64(number));
...
SELECT roundToExp2(number) AS x FROM numbers(3) ORDER BY x, to_float32(x);
SELECT number AS x FROM numbers(3) ORDER BY to_float32(x) as k, toFloat64(k);
SELECT number FROM numbers(3) ORDER BY to_float32(toFloat64(number)) DESC;
...
SELECT roundToExp2(number) AS x FROM numbers(3) ORDER BY x DESC, to_float32(x) DESC;
EXPLAIN SYNTAX SELECT number FROM numbers(3) ORDER BY to_float32(toFloat64(number));
...
EXPLAIN SYNTAX SELECT roundToExp2(number) AS x FROM numbers(3) ORDER BY x, to_float32(x);
EXPLAIN SYNTAX SELECT number AS x FROM numbers(3) ORDER BY to_float32(x) as k, toFloat64(k);
EXPLAIN SYNTAX SELECT number FROM numbers(3) ORDER BY to_float32(toFloat64(number)) DESC;
...
EXPLAIN SYNTAX SELECT roundToExp2(number) AS x FROM numbers(3) ORDER BY x DESC, to_float32(x) DESC;

...
SELECT murmurHash2_32(to_uint16(2));

SELECT murmurHash2_32(2) = bitXor(to_uint32(0x5bd1e995 * bitXor(to_uint32(3 * 0x5bd1e995) AS a, bitShiftRight(a, 13))) AS b, bitShiftRight(b, 15));
SELECT murmurHash2_32('\x02') = bitXor(to_uint32(0x5bd1e995 * bitXor(to_uint32(3 * 0x5bd1e995) AS a, bitShiftRight(a, 13))) AS b, bitShiftRight(b, 15));

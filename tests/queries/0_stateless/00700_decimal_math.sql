...
SELECT toDecimal128('42.42', 4) AS x, to_decimal32(log(x), 4) AS y, round(exp(y), 6);
SELECT toDecimal128('42.42', 4) AS x, to_decimal32(log2(x), 4) AS y, round(exp2(y), 6);
SELECT toDecimal128('42.42', 4) AS x, to_decimal32(log10(x), 4) AS y, round(exp10(y), 6);

SELECT toDecimal128('42.42', 4) AS x, to_decimal32(sqrt(x), 3) AS y, y * y;
SELECT toDecimal128('42.42', 4) AS x, to_decimal32(cbrt(x), 4) AS y, to_decimal64(y, 4) * y * y;

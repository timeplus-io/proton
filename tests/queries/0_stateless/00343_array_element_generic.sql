...
SELECT array_map(x -> to_string(x), range(number))[2] FROM system.numbers LIMIT 10;
SELECT array_map(x -> to_string(x), range(number))[-1] FROM system.numbers LIMIT 10;
SELECT array_map(x -> to_string(x), range(number))[number] FROM system.numbers LIMIT 10;
SELECT array_map(x -> to_string(x), range(number))[2 - number] FROM system.numbers LIMIT 10;

SELECT array_map(x -> range(x), range(number))[2] FROM system.numbers LIMIT 10;
SELECT array_map(x -> range(x), range(number))[-1] FROM system.numbers LIMIT 10;
SELECT array_map(x -> range(x), range(number))[number] FROM system.numbers LIMIT 10;
SELECT array_map(x -> range(x), range(number))[2 - number] FROM system.numbers LIMIT 10;

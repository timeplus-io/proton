...
SELECT count() FROM bftest WHERE hasAny(y, [to_decimal32(123, 3), 2]) FORMAT Null; -- different, doesn't fail
...
SELECT count() FROM bftest WHERE hasAny(x, [to_decimal32(123, 3), 2]) FORMAT Null; -- { serverError 277 }

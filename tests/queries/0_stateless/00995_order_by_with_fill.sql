...
SELECT * FROM fill ORDER BY date WITH FILL FROM to_date('2019-05-01') TO to_date('2019-05-31'), val WITH FILL;
...
SELECT * FROM fill ORDER BY date DESC WITH FILL TO to_date('2019-05-01') STEP -2, val DESC WITH FILL FROM 10 TO -5 STEP -3;

SELECT '*** date WITH FILL TO 2019-06-23 STEP 3, val WITH FILL FROM -10 STEP 2';
SELECT * FROM fill ORDER BY date WITH FILL TO to_date('2019-06-23') STEP 3, val WITH FILL FROM -10 STEP 2;

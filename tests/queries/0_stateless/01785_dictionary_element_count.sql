...
DROP STREAM IF EXISTS 01785_db.simple_key_source_table;
create stream 01785_db.simple_key_source_table
(
    id uint64,
    value string
) ();
...
SELECT to_uint64(1) as key, dictGet('01785_db.simple_key_cache_dictionary', 'value', key);
...
DROP STREAM 01785_db.simple_key_source_table;

DROP STREAM IF EXISTS 01785_db.complex_key_source_table;
create stream 01785_db.complex_key_source_table
(
    id uint64,
    id_key string,
    value string
...
DROP STREAM 01785_db.complex_key_source_table;

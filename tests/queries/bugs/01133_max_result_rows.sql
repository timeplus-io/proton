...
SELECT DISTINCT int_div(number, 10) FROM numbers(300); -- { serverError 396 }
SELECT DISTINCT int_div(number, 10) FROM numbers(190);
SELECT DISTINCT int_div(number, 10) FROM numbers(200);
SELECT DISTINCT int_div(number, 10) FROM numbers(210); -- { serverError 396 }

SET result_overflow_mode = 'break';

SELECT DISTINCT int_div(number, 10) FROM numbers(300);
SELECT DISTINCT int_div(number, 10) FROM numbers(190);
SELECT DISTINCT int_div(number, 10) FROM numbers(200);
SELECT DISTINCT int_div(number, 10) FROM numbers(210);

...
SELECT quantile_timing(0.2)(d), quantile_timing(0.3)(d), quantile_timing(0.2)(d+1) FROM datetime;
SELECT quantile_timing_weighted(0.2)(d, 1), quantile_timing_weighted(0.3)(d, 1), quantile_timing_weighted(0.2)(d, 2) FROM datetime;
...
SELECT 'quantile_timing:';
EXPLAIN SYNTAX SELECT quantile_timing(0.2)(d), quantile_timing(0.3)(d), quantile_timing(0.2)(d+1) FROM datetime;
SELECT quantile_timing(0.2)(d), quantile_timing(0.3)(d), quantile_timing(0.2)(d+1) FROM datetime;

SELECT 'quantileTimingWeighted:';
EXPLAIN SYNTAX SELECT quantile_timing_weighted(0.2)(d, 1), quantile_timing_weighted(0.3)(d, 1), quantile_timing_weighted(0.2)(d, 2) FROM datetime;
SELECT quantile_timing_weighted(0.2)(d, 1), quantile_timing_weighted(0.3)(d, 1), quantile_timing_weighted(0.2)(d, 2) FROM datetime;
...
SELECT quantile_timing(0.5)(NULL, NULL, quantile_timing(-inf)(NULL), NULL) FROM datetime FORMAT Null; -- { serverError ILLEGAL_AGGREGATION }
...
SELECT quantile_timing_weighted([[[[['-214748364.8'], NULL]], [[[quantile_timing_weighted([[[[['-214748364.8'], NULL], '-922337203.6854775808'], [[['-214748364.7']]], NULL]])([NULL], NULL), '-214748364.7']]], NULL]])([NULL], NULL); -- { serverError ILLEGAL_AGGREGATION }
SELECT quantile_timing_weighted([quantile_timing_weighted(0.5)(1, 1)])(1, 1); -- { serverError ILLEGAL_AGGREGATION }

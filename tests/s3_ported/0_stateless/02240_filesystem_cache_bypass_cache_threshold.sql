...
CREATE STREAM test (akey uint32, avalue string) ORDER BY akey Engine=MergeTree()  SETTINGS storage_policy='s3_cache', min_bytes_for_wide_part = 10485760, compress_marks=false, compress_primary_key=false;

...
The config of cluster p3k1 in `smoke/deployment/p3k1.yaml` is for ci!

If you want to run smoke test locally, you can config the `smoke/deployment/p3k1.yaml` as follows:

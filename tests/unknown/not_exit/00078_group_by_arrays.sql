...
SELECT ParsedParams.Key1 AS k1, GeneralInterests AS k2, count() AS c FROM test.hits WHERE not_empty(k1) AND not_empty(k2) GROUP BY k1, k2 ORDER BY c DESC LIMIT 10;

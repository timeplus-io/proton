...
CREATE STREAM issue32107(A int64, s_quantiles aggregate_function(quantilesTDigest(0.1, 0.25, 0.5, 0.75, 0.9, 0.95, 0.99), float64)) ENGINE = AggregatingMergeTree ORDER BY A;

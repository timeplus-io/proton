...
create stream tab (a uint32, b uint32, c uint32, d uint32) engine = MergeTree order by ((a + b) * c, sin(a / b));
...
create stream tab2 (x DateTime, y uint32, z uint32) engine = MergeTree order by (x, y);
...
create stream tab3 (a uint32, b uint32, c uint32, d uint32) engine = MergeTree order by ((a + b) * c, sin(a / b));
insert into tab3 select number, number, number, number from numbers(5);
insert into tab3 select number, number, number, number from numbers(5);

create stream tab4 (a uint32, b uint32, c uint32, d uint32) engine = MergeTree order by sin(a / b);
insert into tab4 select number, number, number, number from numbers(5);
insert into tab4 select number, number, number, number from numbers(5);

create stream tab5 (a uint32, b uint32, c uint32, d uint32) engine = MergeTree order by (a + b) * c;

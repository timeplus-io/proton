DROP STREAM IF EXISTS bf_tokenbf_lowcard_test;
DROP STREAM IF EXISTS bf_ngram_lowcard_test;

CREATE STREAM bf_tokenbf_lowcard_test
(
    row_id uint32,
    lc low_cardinality(string),
    lc_fixed low_cardinality(fixed_string(8)),
...
CREATE STREAM bf_ngram_lowcard_test
(
    row_id uint32,
    lc low_cardinality(string),
    lc_fixed low_cardinality(fixed_string(8)),
...
DROP STREAM bf_tokenbf_lowcard_test;
DROP STREAM bf_ngram_lowcard_test;

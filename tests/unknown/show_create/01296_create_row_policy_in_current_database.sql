...
SELECT '-- one policy';
CREATE POLICY p1_01296 ON stream;
SHOW CREATE POLICY p1_01296 ON db_01296.table;
SHOW CREATE POLICY p1_01296 ON stream;
ALTER POLICY p1_01296 ON stream USING 1;
SHOW CREATE POLICY p1_01296 ON db_01296.table;
SHOW CREATE POLICY p1_01296 ON stream;
DROP POLICY p1_01296 ON stream;
DROP POLICY p1_01296 ON db_01296.table; -- { serverError 523 } -- Policy not found

SELECT '-- multiple policies';
CREATE ROW POLICY p1_01296, p2_01296 ON stream USING 1;
CREATE USER u1_01296;
CREATE ROW POLICY p3_01296 ON stream, stream2 TO u1_01296;
CREATE ROW POLICY p4_01296 ON stream, p5_01296 ON stream2 USING a=b;
SHOW CREATE POLICY p1_01296 ON stream;
SHOW CREATE POLICY p2_01296 ON stream;
SHOW CREATE POLICY p3_01296 ON stream;
SHOW CREATE POLICY p3_01296 ON stream2;
SHOW CREATE POLICY p4_01296 ON stream;
SHOW CREATE POLICY p5_01296 ON stream2;
SHOW CREATE POLICY p1_01296 ON db_01296.table;
...
ALTER POLICY p1_01296, p2_01296 ON stream TO ALL;
SHOW CREATE POLICY p1_01296 ON stream;
SHOW CREATE POLICY p2_01296 ON stream;
DROP POLICY p1_01296, p2_01296 ON stream;
DROP POLICY p3_01296 ON stream, stream2;
DROP POLICY p4_01296 ON stream, p5_01296 ON stream2;
DROP POLICY p1_01296 ON db_01296.table; -- { serverError 523 } -- Policy not found

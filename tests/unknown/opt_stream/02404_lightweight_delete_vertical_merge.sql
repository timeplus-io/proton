...
-- optimize stream to physically delete the rows
...
-- optimize stream to merge 2 parts together: the 1st has LDW rows and the 2nd doesn't have LWD rows
...
-- optimize stream to merge 2 parts together, both of them have LWD rows
-- physically delete the rows
OPTIMIZE STREAM lwd_test FINAL SETTINGS mutations_sync = 2;

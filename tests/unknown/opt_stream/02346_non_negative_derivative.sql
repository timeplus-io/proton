...
INSERT INTO nnd VALUES (1, to_datetime64('1979-12-12 21:21:21.123456788', 9, 'UTC'), 1.1), (2, to_datetime64('1979-12-12 21:21:21.123456789', 9, 'UTC'), 2.34), (3, to_datetime64('1979-12-12 21:21:21.127', 3, 'UTC'), 3.7);
INSERT INTO nnd VALUES (4, to_datetime64('1979-12-12 21:21:21.129', 3, 'UTC'), 2.1), (5, to_datetime('1979-12-12 21:21:22', 'UTC'), 1.3345), (6, to_datetime('1979-12-12 21:21:23', 'UTC'), 1.54), (7, to_datetime('1979-12-12 21:21:23', 'UTC'), 1.54);
...
SELECT (
           ...
           SELECT
               ts,
               metric,
               nonNegativeDerivative(metric, ts, to_intervalSecond(1)) OVER (PARTITION BY metric ORDER BY ts ASC Rows BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS deriv
           FROM nnd
           LIMIT 5, 1
       );

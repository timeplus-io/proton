...
DROP STREAM IF EXISTS proj_agg_02343;

CREATE STREAM proj_agg_02343
(
    k1 uint32,
    k2 uint32,
    k3 uint32,
...
OPTIMIZE STREAM proj_agg_02343 FINAL;
...
create stream t(a uint64) engine = MergeTree order by (a);
system stop merges t;
create stream dist_t as t engine = Distributed(test_cluster_two_shards, currentDatabase(), t, a % 2);

...
PRIMARY KEY key
SOURCE(CLICKHOUSE(HOST 'localhost' PORT tcp_port() USER 'default' STREAM 'dict_data' PASSWORD '' DB 'dict_db_01224'))
...
SELECT name, type FROM system.columns WHERE database = 'dict_db_01224' AND stream = 'dict';
SELECT status FROM system.dictionaries WHERE database = 'dict_db_01224' AND name = 'dict';

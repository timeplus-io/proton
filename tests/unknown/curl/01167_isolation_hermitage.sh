...
function hard_reset_table()
{
    ...
    $CLICKHOUSE_CLIENT -q "create stream test (id int, value int) engine=MergeTree order by id SETTINGS old_parts_lifetime = 5"
...
function reset_table()
{
    ...
    # In order not to wait too long (>60s) there is used a fallback to stream recreation
...
tx 1 "alter stream test update value=11 where id=1"
tx 2                                            "alter stream test update value=12 where id=1" | grep -Eo "Serialization error" | uniq
tx 1 "alter stream test update value=21 where id=2"
tx 1 "commit"
tx 2                                            "alter stream test update value=22 where id=2" | grep -Eo "INVALID_TRANSACTION" | uniq
...
tx_async 3 "alter stream test update value=101 where id=1"
tx_async 4                                           "select 2, * from test order by id"
tx_async 3 "alter stream test update value=11 where id=1"
tx_async 3 "rollback"
...
tx_async 5 "alter stream test update value=101 where id=1"
tx_async 6                                           "select 5, * from test order by id"
tx_async 5 "alter stream test update value=11 where id=1"
tx_async 5 "commit"
...
tx 7 "alter stream test update value=11 where id=1"
tx 8                                            "alter stream test update value=22 where id=2" | grep -Eo "Serialization error" | uniq
...
tx 9 "alter stream test update value = 11 where id = 1"
tx 9 "alter stream test update value = 19 where id = 2"
tx 10                     "alter stream test update value = 12 where id = 1" | grep -Eo "Serialization error" | uniq
tx 9 "commit"
tx 11                                         "select 11, * from test order by id"
tx 10                     "alter stream test update value = 18 where id = 2" | grep -Eo "INVALID_TRANSACTION" | uniq
...
tx 14 "alter stream test update value = value + 10 where 1"
tx 15                                              "alter stream test delete where value = 20" | grep -Eo "Serialization error" | uniq
tx 14 "commit"
...
tx 16 "alter stream test update value = 11 where id = 1"
tx 17                                              "alter stream test update value = 11 where id = 1" | grep -Eo "Serialization error" | uniq
tx 16 "commit"
...
tx_async 19                                              "alter stream test update value = 12 where id = 1"
tx_async 19                                              "alter stream test update value = 18 where id = 2"
tx_async 19                                              "commit"

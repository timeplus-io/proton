...
CREATE DATABASE some_tests ENGINE=Ordinary; -- Different inner stream name with Atomic

create stream some_tests.my_table ENGINE = MergeTree(day, (day), 8192) as select today() as day, 'mystring' as str;

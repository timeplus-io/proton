...
# Open connections
servers = [
    {"host": host or args.host[0], "port": port or args.port[0], "user": "proton", "password": "proton@t+"}
...
all_connections = [
    proton_driver.Client(**server, settings_is_important=True) for server in servers
]
...
for query_index in queries_to_run:
    ...
    for conn_index, c in enumerate(all_connections):
        try:
            ...
            except proton_driver.errors.Error as e:

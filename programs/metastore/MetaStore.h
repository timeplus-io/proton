...
/// standalone clickhouse-metastore server. Uses the same
/// config as clickhouse-server. Serves requests on HTTP ports.
class MetaStore : public BaseDaemon, public IServer
{
public:

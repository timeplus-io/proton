macro(proton_strip_binary)
   ...
   add_custom_command(TARGET ${STRIP_TARGET} POST_BUILD
     COMMAND bash ${proton_SOURCE_DIR}/cmake/strip.sh ${STRIP_BINARY_PATH} ${STRIP_DESTINATION_DIR} ${OBJCOPY_PATH} ${READELF_PATH}
   ...
   install(DIRECTORY ${STRIP_DESTINATION_DIR}/lib/debug DESTINATION ${CMAKE_INSTALL_LIBDIR} COMPONENT proton)
endmacro()
